...
namespace FixMath.NET
{
    ...
    public partial struct Fix64 : IEquatable<Fix64>, IComparable<Fix64>
    {
        ...
        public static Fix64 Asin(Fix64 x)
        {
            ...
            if (x.m_rawValue == 0) return Zero;

            var result = PiOver2 - Atan(Acos(x));
            return result;
        }
        ...
        public static bool IsNegativeInfinity(Fix64 value)
        {
            return false;
        }
...
@"
        ...
        /// </summary>
        public static Fix64 BuildFromRawLong(long rawValue)
        {
            return new Fix64(rawValue);
        }
