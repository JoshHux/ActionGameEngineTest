...
namespace VelcroPhysics.Collision.ContactSystem
{
    ...
    public class Contact
    {
        ...
        /// <summary>
        /// Evaluate this contact with your own manifold and VTransforms.
        /// </summary>
        /// <param name="manifold">The manifold.</param>
        /// <param name="VTransformA">The first VTransform.</param>
        /// <param name="VTransformB">The second VTransform.</param>
        private void Evaluate(ref Manifold manifold, ref VTransform VTransformA, ref VTransform VTransformB)
        {
            switch (_type)
            {
