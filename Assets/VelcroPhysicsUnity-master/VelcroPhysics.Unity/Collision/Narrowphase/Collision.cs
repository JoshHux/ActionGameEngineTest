...
namespace VelcroPhysics.Collision.Narrowphase
{
    ...
    public static class Collision
    {
        ...
        /// <param name="xfA">The VTransform for the first shape.</param>
        /// <param name="xfB">The VTransform for the seconds shape.</param>
        /// <returns></returns>
        public static bool TestOverlap(Shape shapeA, int indexA, Shape shapeB, int indexB, ref VTransform xfA,
            ref VTransform xfB)
        {
            var input = new DistanceInput();
            input.ProxyA = new DistanceProxy(shapeA, indexA);
            input.ProxyB = new DistanceProxy(shapeB, indexB);
            input.VTransformA = xfA;
            input.VTransformB = xfB;
            input.UseRadii = true;
