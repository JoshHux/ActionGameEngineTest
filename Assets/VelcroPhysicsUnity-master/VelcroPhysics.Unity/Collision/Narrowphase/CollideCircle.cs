...
namespace VelcroPhysics.Collision.Narrowphase
{
    public static class CollideCircle
    {
        ...
        /// </summary>
        public static void CollideCircles(ref Manifold manifold, CircleShape circleA, ref VTransform xfA,
            CircleShape circleB, ref VTransform xfB)
        {
        ...
        /// <param name="xfA">The VTransform of A.</param>
        /// <param name="circleB">The circle B.</param>
        /// <param name="xfB">The VTransform of B.</param>
        public static void CollidePolygonAndCircle(ref Manifold manifold, PolygonShape polygonA, ref VTransform xfA,
            CircleShape circleB, ref VTransform xfB)
        {
            manifold.PointCount = 0;
