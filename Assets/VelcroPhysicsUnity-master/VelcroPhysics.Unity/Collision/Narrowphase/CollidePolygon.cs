...
namespace VelcroPhysics.Collision.Narrowphase
{
    public static class CollidePolygon
    {
        ...
        /// </summary>
        public static void CollidePolygons(ref Manifold manifold, PolygonShape polyA, ref VTransform xfA,
            PolygonShape polyB, ref VTransform xfB)
        {
        ...
        private static void FindIncidentEdge(out FixedArray2<ClipVertex> c, PolygonShape poly1, ref VTransform xf1,
            int edge1, PolygonShape poly2, ref VTransform xf2)
        {
