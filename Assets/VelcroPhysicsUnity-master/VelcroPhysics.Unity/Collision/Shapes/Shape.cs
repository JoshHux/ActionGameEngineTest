...
namespace VelcroPhysics.Collision.Shapes
{
    ...
    public abstract class Shape
    {
        ...
        /// <param name="VTransform">The VTransform to be applied to the shape.</param>
        /// <param name="childIndex">The child shape index.</param>
        /// <param name="output">The ray-cast results.</param>
        /// <returns>True if the ray-cast hits the shape</returns>
        public abstract bool RayCast(ref RayCastInput input, ref VTransform VTransform, int childIndex,
        ...
        public abstract void ComputeAABB(ref VTransform VTransform, int childIndex, out AABB aabb);
