...
namespace VelcroPhysics.Collision.Shapes
{
    ...
    public class CircleShape : Shape
    {
        ...
        public CircleShape(Fix64 radius, Fix64 density) : base(ShapeType.Circle, radius, density)
        {
            ComputeProperties();
        }
        ...
        {
            return TestPointHelper.TestPointCircle(ref _position, _radius, ref point, ref VTransform);
        }

        public override bool RayCast(ref RayCastInput input, ref VTransform VTransform, int childIndex,
            out RayCastOutput output)
        {
            return RayCastHelper.RayCastCircle(ref _position, Radius, ref input, ref VTransform, out output);
        }

        public override void ComputeAABB(ref VTransform VTransform, int childIndex, out AABB aabb)
        {
            AABBHelper.ComputeCircleAABB(ref _position, _radius, ref VTransform, out aabb);
        }
