...
namespace VelcroPhysics.Collision.Shapes
{
    ...
    public class EdgeShape : Shape
    {
        ...
        {
            return RayCastHelper.RayCastEdge(ref _vertex1, ref _vertex2, ref input, ref VTransform, out output);
        }

        public override void ComputeAABB(ref VTransform VTransform, int childIndex, out AABB aabb)
        {
            AABBHelper.ComputeEdgeAABB(ref _vertex1, ref _vertex2, ref VTransform, out aabb);
        }
