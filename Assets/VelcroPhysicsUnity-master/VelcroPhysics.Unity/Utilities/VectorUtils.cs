...
namespace VelcroPhysics.Utilities
{
    ...
    {
        public static Vector2 VTransform(this Vector2 position, Matrix4x4 matrix)
        {
            VTransform(ref position, ref matrix, out position);
            return position;
        }

        public static void VTransform(this ref Vector2 position, ref Matrix4x4 matrix, out Vector2 result)
        {
        ...
        public static void VTransform(this Vector2[] sourceArray, ref Matrix4x4 matrix, Vector2[] destinationArray)
        {
            throw new NotImplementedException();
        }

        public static void VTransform(this Vector2[] sourceArray, int sourceIndex, ref Matrix4x4 matrix,
