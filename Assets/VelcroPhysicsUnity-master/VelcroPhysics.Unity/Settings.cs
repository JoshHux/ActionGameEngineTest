...
namespace VelcroPhysics
{
    public static class Settings
    {
        ...
        /// This is in meters.
        /// </summary>
        public static Fix64 AABBExtension = FixedMath.C0p1;
        ...
        /// </summary>
        public static Fix64 AABBMultiplier = Fix64.One * 2;
        ...
        /// chosen to be numerically significant, but visually insignificant.
        /// </summary>
        public static Fix64 AngularSlop = (Fix64.One * 2) / (Fix64.One * 180) * Fix64.Pi;
        ...
        /// </summary>
        public static Fix64 PolygonRadius = 2 * LinearSlop;
        ...
        /// prevent overshoot.
        /// </summary>
        public static Fix64 MaxLinearCorrection = FixedMath.C0p1 * 2;

        /// <summary>
        /// The maximum angular position correction used when solving constraints. This helps to
        /// prevent overshoot.
        /// </summary>
        public static Fix64 MaxAngularCorrection = (Fix64.One * 8) / (Fix64.One * 180) * Pi;
        ...
        /// to overshoot.
        /// </summary>
        public static Fix64 Baumgarte = FixedMath.C0p1 * 2;

        // Sleep
        /// <summary>
        /// The time that a body must be still before it will go to sleep.
        /// </summary>
        public static Fix64 TimeToSleep = FixedMath.C0p5;

        /// <summary>
        /// A body cannot sleep if its linear velocity is above this tolerance.
        /// </summary>
        public static Fix64 LinearSleepTolerance = FixedMath.C0p01;

        /// <summary>
        /// A body cannot sleep if its angular velocity is above this tolerance.
        /// </summary>
        public static Fix64 AngularSleepTolerance = (Fix64.One * 2) / (Fix64.One * 180) * Fix64.Pi;

        /// <summary>
        /// The maximum linear velocity of a body. This limit is very large and is used
        /// to prevent numerical problems. You shouldn't need to adjust this.
        /// </summary>
        public static Fix64 MaxTranslation = Fix64.One * 2;

        public static Fix64 MaxTranslationSquared = MaxTranslation * MaxTranslation;

        /// <summary>
        /// The maximum angular velocity of a body. This limit is very large and is used
        /// to prevent numerical problems. You shouldn't need to adjust this.
        /// </summary>
        public static Fix64 MaxRotation = Fix64.PiOver2;

        public static Fix64 MaxRotationSquared = MaxRotation * MaxRotation;
