...
namespace VelcroPhysics.Dynamics
{
    ...
    /// inherits its VTransform from its parent. Fixtures hold additional non-geometric data
    ...
    public class Fixture
    {
        ...
        internal void Synchronize(IBroadPhase broadPhase, ref VTransform VTransform1, ref VTransform VTransform2)
        {
            ...
            for (var i = 0; i < ProxyCount; ++i)
            {
                ...
                AABB aabb1, aabb2;
                Shape.ComputeAABB(ref VTransform1, proxy.ChildIndex, out aabb1);
                Shape.ComputeAABB(ref VTransform2, proxy.ChildIndex, out aabb2);

                proxy.AABB.Combine(ref aabb1, ref aabb2);

                var displacement = VTransform2.p - VTransform1.p;
