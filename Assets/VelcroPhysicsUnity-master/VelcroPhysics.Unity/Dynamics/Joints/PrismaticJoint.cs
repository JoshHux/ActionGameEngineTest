...
namespace VelcroPhysics.Dynamics.VJoints
{
    ...
    public class PrismaticVJoint : VJoint
    {
        ...
        public PrismaticVJoint(Body bodyA, Body bodyB, Vector2 anchorA, Vector2 anchorB, Vector2 axis,
        ...
        public PrismaticVJoint(Body bodyA, Body bodyB, Vector2 anchor, Vector2 axis, bool useWorldCoordinates = false)
            : base(bodyA, bodyB)
        {
        ...
        internal override void InitVelocityConstraints(ref SolverData data)
        {
            ...
            if (_enableLimit)
            {
                var VJointTranslation = Vector2.Dot(_axis, d);
