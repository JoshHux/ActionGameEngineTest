...
namespace VelcroPhysics.Dynamics.VJoints
{
    ...
    public class RevoluteVJoint : VJoint
    {
        ...
        public RevoluteVJoint(Body bodyA, Body bodyB, Vector2 anchorA, Vector2 anchorB, bool useWorldCoordinates = false)
            : base(bodyA, bodyB)
        {
            VJointType = VJointType.Revolute;
        ...
        public RevoluteVJoint(Body bodyA, Body bodyB, Vector2 anchor, bool useWorldCoordinates = false)
        ...
        /// </summary>
        public float VJointAngle => BodyB._sweep.A - BodyA._sweep.A - ReferenceAngle;

        /// <summary>
        /// Get the current VJoint angle speed in radians per second.
        /// </summary>
        public float VJointSpeed => BodyB._angularVelocity - BodyA._angularVelocity;
