...
namespace Box2DX.Collision
{
	...
	public abstract class Shape : IDisposable
	{
		...
		/// <returns></returns>
		public abstract bool TestPoint(XForm xf, FVec2 p);
		...
		public abstract SegmentCollide TestSegment(XForm xf, out Fix64 lambda, out FVec2 normal, Segment segment, Fix64 maxLambda);
		...
		public abstract void ComputeMass(out MassData massData, Fix64 density);
		...
		public abstract Fix64 ComputeSubmergedArea(FVec2 normal, Fix64 offset, XForm xf, out FVec2 c);
		...
		public abstract Fix64 ComputeSweepRadius(FVec2 pivot);

		public abstract FVec2 GetVertex(int index);

		public abstract int GetSupport(FVec2 d);

		public abstract FVec2 GetSupportVertex(FVec2 d);
