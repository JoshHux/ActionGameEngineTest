...
namespace Box2DX.Collision
{
	public partial class Collision
	{
		...
		public static void CollideEdgeAndCircle(ref Manifold manifold, EdgeShape edge, XForm transformA, CircleShape circle, XForm transformB)
		{
			...
			FVec2 cLocal = Common.Math.MulT(transformA, Common.Math.Mul(transformB, circle._position));
			FVec2 normal = edge._normal;
			FVec2 v1 = edge._v1;
			FVec2 v2 = edge._v2;
			Fix64 radius = edge._radius + circle._radius;
			...
			{
				Fix64 separation = FVec2.Dot(cLocal - v1, normal);
				...
				manifold.PointCount = 1;
				manifold.Type = ManifoldType.FaceA;
				manifold.LocalPlaneNormal = separation < Fix64.Zero ? -normal : normal;
