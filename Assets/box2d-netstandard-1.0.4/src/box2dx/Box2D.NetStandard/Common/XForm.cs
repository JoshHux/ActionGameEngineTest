...
namespace Box2DX.Common
{
	...
	public struct XForm
	{
		...
		/// <param name="R"></param>
		public XForm(FVec2 position, Mat22 rotation)
		{
			Position = position;
			R = rotation;
		}
		...
		public void Set(FVec2 p, Fix64 angle)
		{
			Position = p;
			R.Set(angle);
		}
		...
		public static XForm Identity { get { return new XForm(FVec2.Zero, Mat22.Identity); } }
	}
}
