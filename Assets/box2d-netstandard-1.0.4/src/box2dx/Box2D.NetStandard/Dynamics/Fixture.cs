...
namespace Box2DX.Dynamics
{
	...
	{
		public FVec2 LocalPosition;
		public Fix64 Radius;

		public CircleDef()
		{
			Type = ShapeType.CircleShape;
			LocalPosition = FVec2.Zero;
			Radius = Fix64.One;
		}
	}
	...
	public class PolygonDef : FixtureDef
	{
		...
		/// </summary>
		public FVec2[] Vertices = new FVec2[Settings.MaxPolygonVertices];
	...
	public class Fixture
	{
		...
		public Fix64 ComputeSubmergedArea(FVec2 normal, Fix64 offset, out FVec2 c)
		{
		...
		public SegmentCollide TestSegment(out Fix64 lambda, out FVec2 normal, Segment segment, Fix64 maxLambda)
		{
		...
		/// </summary>
		public Fix64 ComputeSweepRadius(FVec2 pivot)
		{
