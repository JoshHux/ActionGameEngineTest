...
{
	/// <summary>
	/// BJoints and shapes are destroyed when their associated
	...
	public abstract class DestructionListener
	{
		...
		/// </summary>
		public abstract void SayGoodbye(BJoint joint);
	...
	{
		public Fix64[] normalImpulses = new Fix64[Settings.MaxManifoldPoints];
		public Fix64[] tangentImpulses = new Fix64[Settings.MaxManifoldPoints];
	}
	...
	public struct Color
	{
		...
		public void Set(Fix64 r, Fix64 g, Fix64 b)
		{
			R = r; G = g; B = b;
		}
	}
	...
	public abstract class DebugDraw
	{
		...
		public enum DrawFlags
		{
			...
			BJoint = 0x0002, // draw joint connections
		...
		/// </summary>
		public abstract void DrawPolygon(FVec2[] vertices, int vertexCount, Color color);

		/// <summary>
		/// Draw a solid closed polygon provided in CCW order.
		/// </summary>
		public abstract void DrawSolidPolygon(FVec2[] vertices, int vertexCount, Color color);

		/// <summary>
		/// Draw a circle.
		/// </summary>
		public abstract void DrawCircle(FVec2 center, Fix64 radius, Color color);

		/// <summary>
		/// Draw a solid circle.
		/// </summary>
		public abstract void DrawSolidCircle(FVec2 center, Fix64 radius, FVec2 axis, Color color);

		/// <summary>
		/// Draw a line segment.
		/// </summary>
		public abstract void DrawSegment(FVec2 p1, FVec2 p2, Color color);
