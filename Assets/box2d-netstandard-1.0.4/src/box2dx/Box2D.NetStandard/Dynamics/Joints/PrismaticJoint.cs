...
namespace Box2DX.Dynamics
{
    ...
    /// </summary>
    public class PrismaticBJointDef : BJointDef
    {
        public PrismaticBJointDef()
        {
            Type = BJointType.PrismaticBJoint;
    ...
    /// </summary>
    public class PrismaticBJoint : BJoint
    {
        ...
        /// </summary>
        public Fix64 BJointTranslation
        {
            get
            {
                Body b1 = _body1;
        ...
        public PrismaticBJoint(PrismaticBJointDef def)
            : base(def)
        {
        ...
        internal override void InitVelocityConstraints(TimeStep step)
        {
            ...
            if (step.WarmStarting)
            {
                ...
                FVec2 P = _impulse.X * _perp + (_motorImpulse + _impulse.Z) * _axis;
        ...
        internal override void SolveVelocityConstraints(TimeStep step)
        {
            ...
            FVec2 Cdot1;
            Cdot1.X = FVec2.Dot(_perp, v2 - v1) + _s2 * w2 - _s1 * w1;
            Cdot1.Y = w2 - w1;
            ...
            if (_enableLimit && _limitState != LimitState.InactiveLimit)
            {
                ...
                Fix64 Cdot2;
                Cdot2 = FVec2.Dot(_axis, v2 - v1) + _a2 * w2 - _a1 * w1;
                FVec3 Cdot = new FVec3(Cdot1.X, Cdot1.Y, Cdot2);

                FVec3 f1 = _impulse;
                FVec3 df = _K.Solve33(-Cdot);
                _impulse += df;
                ...
                // f2(1:2) = invK(1:2,1:2) * (-Cdot(1:2) - K(1:2,3) * (f2(3) - f1(3))) + f1(1:2)
                FVec2 b = -Cdot1 - (_impulse.Z - f1.Z) * new FVec2(_K.Col3.X, _K.Col3.Y);
                FVec2 f2r = _K.Solve22(b) + new FVec2(f1.X, f1.Y);
                _impulse.X = f2r.X;
                _impulse.Y = f2r.Y;

                df = _impulse - f1;

                FVec2 P = df.X * _perp + df.Z * _axis;
        ...
        internal override bool SolvePositionConstraints(Fix64 baumgarte)
        {
            ...
            else
            {
                ...
                FVec2 impulse1 = _K.Solve22(-C1);
                impulse.X = impulse1.X;
                impulse.Y = impulse1.Y;
                impulse.Z = Fix64.Zero;
            }

            FVec2 P = impulse.X * _perp + impulse.Z * _axis;
