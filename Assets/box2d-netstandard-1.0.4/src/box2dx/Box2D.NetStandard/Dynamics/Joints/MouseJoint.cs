...
namespace Box2DX.Dynamics
{
	...
	/// </summary>
	public class MouseBJointDef : BJointDef
	{
		public MouseBJointDef()
		{
			Type = BJointType.MouseBJoint;
			Target.Set(Fix64.Zero, Fix64.Zero);
			MaxForce = Fix64.Zero;
			FrequencyHz = (Fix64)5.0f;
			DampingRatio =(Fix64) 0.7f;
		}
	...
	/// </summary>
	public class MouseBJoint : BJoint
	{
		public FVec2 _localAnchor;
		public FVec2 _target;
		public FVec2 _impulse;

		public Mat22 _mass;		// effective mass for point-to-point constraint.
		public FVec2 _C;				// position error
		...
		/// </summary>
		public void SetTarget(FVec2 target)
		{
		...
		public MouseBJoint(MouseBJointDef def)
			: base(def)
		{
			_target = def.Target;
		...
		internal override void InitVelocityConstraints(TimeStep step)
		{
			...
			// Damping coefficient
			Fix64 d = (Fix64)2.0f * mass * _dampingRatio * omega;
			...
			FVec2 r = Common.Math.Mul(b.GetXForm().R, _localAnchor - b.GetLocalCenter());
			...
			b._angularVelocity *= (Fix64)0.98f;

			// Warm starting.
			_impulse *= step.DtRatio;
			b._linearVelocity += invMass * _impulse;
			b._angularVelocity += invI * FVec2.Cross(r, _impulse);
		}
		...
		internal override void SolveVelocityConstraints(TimeStep step)
		{
			...
			// Cdot = v + cross(w, r)
			FVec2 Cdot = b._linearVelocity + FVec2.Cross(b._angularVelocity, r);
			FVec2 impulse = Box2DX.Common.Math.Mul(_mass, -(Cdot + _beta * _C + _gamma * _impulse));

			FVec2 oldImpulse = _impulse;
			_impulse += impulse;
			...
			b._angularVelocity += b._invI * FVec2.Cross(r, impulse);
		}
