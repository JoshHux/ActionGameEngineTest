...
namespace FlatPhysics.Unity
{
    public class FBox : FRigidbody
    {
        ...
        protected override void InstantiateBody(CollisionLayer collidesWith)
        {
            ...
            FlatBody.CreateBoxBody(this._width, this._height, this.mass, pos, this.isStatic, this.isPushbox, this.isTrigger, rot, layer, collidesWith, this.gameObject, out this._rb, out thing);
