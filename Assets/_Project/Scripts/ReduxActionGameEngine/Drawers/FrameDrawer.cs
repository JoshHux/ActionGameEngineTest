...
namespace ActionGameEngine.Data.Drawer
{
    ...
    public class FrameDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            var frameRect = new Rect(rectPosX + 65f, rectPosY, rectWidth, EditorGUI.GetPropertyHeight(frameProp));
            var frameRect2 = new Rect(rectPosX, rectPosY, rectWidth, EditorGUI.GetPropertyHeight(frameProp));
            ...
            var fromGUI = EditorGUI.IntField(frameRect, frameProp.intValue + 1);
            ...
            property.isExpanded = EditorGUI.Foldout(frameRect2, property.isExpanded, frameLabel);
