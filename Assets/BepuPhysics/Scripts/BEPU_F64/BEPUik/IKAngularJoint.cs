...
namespace BEPUik
{
    ...
    public class IKAngularJoint : IKJoint
    {
        ...
        /// </summary>
        public BepuQuaternion GoalRelativeOrientation;
        ...
        {  
            ...
            BepuQuaternion.Concatenate(ref ConnectionB.Orientation, ref orientationAConjugate, out GoalRelativeOrientation);
        ...
        protected internal override void UpdateJacobiansAndVelocityBias()
        {
            ...
            BepuQuaternion.Concatenate(ref GoalRelativeOrientation, ref ConnectionA.Orientation, out bTarget);
