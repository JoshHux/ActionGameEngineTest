...
namespace BEPUik
{
    ...
    public class Bone
    {
        ...
        /// </summary>
        public BepuQuaternion Orientation = BepuQuaternion.Identity;
        ...
        public Bone(BepuVector3 position, BepuQuaternion orientation, Fix64 radius, Fix64 height, Fix64 mass)
        ...
        /// <param name="radius">Radius of the bone.</param>
        /// <param name="height">Height of the bone.</param>
        public Bone(BepuVector3 position, BepuQuaternion orientation, Fix64 radius, Fix64 height)
        {
            Mass = F64.C1;
            Position = position;
        ...
        internal void UpdatePosition()
        {
            ...
            BepuVector3.Add(ref Position, ref linearVelocity, out Position);

            //Update the orientation based on the angular velocity.
            BepuVector3 increment;
            BepuVector3.Multiply(ref angularVelocity, F64.C0p5, out increment);
            ...
            linearVelocity = new BepuVector3();
            angularVelocity = new BepuVector3();
        ...
        internal void ApplyLinearImpulse(ref BepuVector3 impulse)
        {
            BepuVector3 velocityChange;
            BepuVector3.Multiply(ref impulse, inverseMass, out velocityChange);
            BepuVector3.Add(ref linearVelocity, ref velocityChange, out linearVelocity);
        }

        internal void ApplyAngularImpulse(ref BepuVector3 impulse)
        {
            BepuVector3 velocityChange;
            Matrix3x3.Transform(ref impulse, ref inertiaTensorInverse, out velocityChange);
            BepuVector3.Add(ref velocityChange, ref angularVelocity, out angularVelocity);
        }
