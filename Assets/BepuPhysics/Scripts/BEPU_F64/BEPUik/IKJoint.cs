...
namespace BEPUik
{
    ...
    public abstract class IKJoint : IKConstraint
    {
        ...
        internal BepuVector3 velocityBias;
        ...
        internal BepuVector3 accumulatedImpulse;
        ...
        protected internal override void SolveVelocityIteration()
        {
            ...
            BepuVector3 constraintVelocityError;
            BepuVector3.Add(ref linearContributionA, ref angularContributionA, out constraintVelocityError);
            BepuVector3.Add(ref constraintVelocityError, ref linearContributionB, out constraintVelocityError);
            BepuVector3.Add(ref constraintVelocityError, ref angularContributionB, out constraintVelocityError);
            ...
            BepuVector3.Subtract(ref constraintVelocityError, ref velocityBias, out constraintVelocityError);
            //And second, the bias from softness:
            BepuVector3 softnessBias;
            BepuVector3.Multiply(ref accumulatedImpulse, -softness, out softnessBias);
            BepuVector3.Subtract(ref constraintVelocityError, ref softnessBias, out constraintVelocityError);
            ...
            BepuVector3 constraintSpaceImpulse;
            Matrix3x3.Transform(ref constraintVelocityError, ref effectiveMass, out constraintSpaceImpulse);

            BepuVector3.Negate(ref constraintSpaceImpulse, out constraintSpaceImpulse);

            //Add the constraint space impulse to the accumulated impulse so that warm starting and softness work properly.
            BepuVector3 preadd = accumulatedImpulse;
            BepuVector3.Add(ref constraintSpaceImpulse, ref accumulatedImpulse, out accumulatedImpulse);
            ...
            if (impulseSquared > maximumImpulseSquared)
            {
                ...
                BepuVector3.Multiply(ref accumulatedImpulse, maximumImpulse / Fix64.Sqrt(impulseSquared), out accumulatedImpulse);
                //Update the impulse based upon the clamped accumulated impulse and the original, pre-add accumulated impulse.
                BepuVector3.Subtract(ref accumulatedImpulse, ref preadd, out constraintSpaceImpulse);
            }
        ...
        {
            accumulatedImpulse = new BepuVector3();
        }
    }
}
