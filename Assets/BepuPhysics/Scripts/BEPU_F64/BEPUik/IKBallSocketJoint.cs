...
namespace BEPUik
{
    ...
    public class IKBallSocketJoint : IKJoint
    {
        ...
        {
            get { return BepuQuaternion.Transform(LocalOffsetA, ConnectionA.Orientation); }
            set { LocalOffsetA = BepuQuaternion.Transform(value, BepuQuaternion.Conjugate(ConnectionA.Orientation)); }
        }
        ...
        {
            get { return BepuQuaternion.Transform(LocalOffsetB, ConnectionB.Orientation); }
            set { LocalOffsetB = BepuQuaternion.Transform(value, BepuQuaternion.Conjugate(ConnectionB.Orientation)); }
        }
        ...
        public IKBallSocketJoint(Bone connectionA, Bone connectionB, BepuVector3 anchor)
        ...
        protected internal override void UpdateJacobiansAndVelocityBias()
        {
            ...
            BepuVector3 rA;
            BepuQuaternion.Transform(ref LocalOffsetA, ref ConnectionA.Orientation, out rA);
            ...
            BepuVector3 worldPositionA;
            BepuVector3.Add(ref ConnectionA.Position, ref rA, out worldPositionA);

            BepuVector3 rB;
            BepuQuaternion.Transform(ref LocalOffsetB, ref ConnectionB.Orientation, out rB);
            Matrix3x3.CreateCrossProduct(ref rB, out angularJacobianB);

            BepuVector3 worldPositionB;
            BepuVector3.Add(ref ConnectionB.Position, ref rB, out worldPositionB);

            BepuVector3 linearError;
            BepuVector3.Subtract(ref worldPositionB, ref worldPositionA, out linearError);
