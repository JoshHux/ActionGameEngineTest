...
namespace BEPUutilities
{
    ...
    public struct BoundingBox
    {
        ...
        public BoundingBox(BepuVector3 min, BepuVector3 max)
        {
            this.Min = min;
            this.Max = max;
        }
        ...
        public BepuVector3[] GetCorners()
        {
            var toReturn = new BepuVector3[8];
            toReturn[0] = new BepuVector3(Min.X, Max.Y, Max.Z);
            toReturn[1] = Max;
            toReturn[2] = new BepuVector3(Max.X, Min.Y, Max.Z);
            toReturn[3] = new BepuVector3(Min.X, Min.Y, Max.Z);
            toReturn[4] = new BepuVector3(Min.X, Max.Y, Min.Z);
            toReturn[5] = new BepuVector3(Max.X, Max.Y, Min.Z);
            toReturn[6] = new BepuVector3(Max.X, Min.Y, Min.Z);
            toReturn[7] = Min;
            return toReturn;
        }
        ...
        public void Intersects(ref BoundingSphere boundingSphere, out bool intersects)
        {
            ...
            BepuVector3.DistanceSquared(ref clampedLocation, ref boundingSphere.Center, out distanceSquared);
        ...
        public static BoundingBox CreateFromPoints(IList<BepuVector3> points)
        {
            BoundingBox aabb;
            if (points.Count == 0)
