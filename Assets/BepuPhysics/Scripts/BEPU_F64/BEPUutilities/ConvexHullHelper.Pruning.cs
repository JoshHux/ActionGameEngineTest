...
namespace BEPUutilities
{
    public static partial class ConvexHullHelper
    {
        ...
        public static void RemoveRedundantPoints(IList<BepuVector3> points)
        {
        ...
        public static void RemoveRedundantPoints(IList<BepuVector3> points, Fix64 cellSize)
        {
        ...
        /// </summary>
        /// <param name="points">List of points to prune.</param>
        public static void RemoveRedundantPoints(RawList<BepuVector3> points)
        {
            RemoveRedundantPoints(points, F64.C0p001);
        }
        ...
        /// <param name="points">List of points to prune.</param>
        /// <param name="cellSize">Size of cells to determine redundancy.</param>
        public static void RemoveRedundantPoints(RawList<BepuVector3> points, Fix64 cellSize)
        {
