...
namespace BEPUutilities
{
    ...
    public struct Matrix2x3
    {
        ...
        public static void Transform(ref BepuVector2 v, ref Matrix2x3 matrix, out BepuVector3 result)
        {
#if !WINDOWS
        ...
        public static void Transform(ref BepuVector3 v, ref Matrix2x3 matrix, out BepuVector2 result)
        {
#if !WINDOWS
