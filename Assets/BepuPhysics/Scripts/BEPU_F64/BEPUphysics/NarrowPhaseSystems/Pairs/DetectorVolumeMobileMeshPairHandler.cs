...
namespace BEPUphysics.NarrowPhaseSystems.Pairs
{
    ...
    public class DetectorVolumeMobileMeshPairHandler : DetectorVolumePairHandler
    {
        ...
        private TriangleShape detectorTriangle = new TriangleShape { collisionMargin = F64.C0 };
        ...
        public override void UpdateCollision(Fix64 dt)
        {
            ...
            mobileTriangleTransform.Orientation = BepuQuaternion.Identity;
            detectorTriangleTransform.Orientation = BepuQuaternion.Identity;
            for (int i = 0; i < meshData.Indices.Length; i += 3)
            {
                ...
                BepuVector3.Add(ref mobileTriangle.vA, ref mobileTriangle.vB, out mobileTriangleTransform.Position);
                BepuVector3.Add(ref mobileTriangle.vC, ref mobileTriangleTransform.Position, out mobileTriangleTransform.Position);
                BepuVector3.Multiply(ref mobileTriangleTransform.Position, F64.OneThird, out mobileTriangleTransform.Position);
                BepuVector3.Subtract(ref mobileTriangle.vA, ref mobileTriangleTransform.Position, out mobileTriangle.vA);
                BepuVector3.Subtract(ref mobileTriangle.vB, ref mobileTriangleTransform.Position, out mobileTriangle.vB);
                BepuVector3.Subtract(ref mobileTriangle.vC, ref mobileTriangleTransform.Position, out mobileTriangle.vC);
                ...
                for (int j = 0; j < overlaps.Count; j++)
                {
                    ...
                    BepuVector3.Add(ref detectorTriangle.vA, ref detectorTriangle.vB, out detectorTriangleTransform.Position);
                    BepuVector3.Add(ref detectorTriangle.vC, ref detectorTriangleTransform.Position, out detectorTriangleTransform.Position);
                    BepuVector3.Multiply(ref detectorTriangleTransform.Position, F64.OneThird, out detectorTriangleTransform.Position);
                    BepuVector3.Subtract(ref detectorTriangle.vA, ref detectorTriangleTransform.Position, out detectorTriangle.vA);
                    BepuVector3.Subtract(ref detectorTriangle.vB, ref detectorTriangleTransform.Position, out detectorTriangle.vB);
                    BepuVector3.Subtract(ref detectorTriangle.vC, ref detectorTriangleTransform.Position, out detectorTriangle.vC);
