    ...
    public abstract class TerrainPairHandler : StandardPairHandler
    {
        ...
        public override void UpdateTimeOfImpact(Collidable requester, Fix64 dt)
        {
            ...
            if (convex.IsActive && convex.entity.PositionUpdateMode == PositionUpdateMode.Continuous)
            {
                ...
                BepuVector3.Multiply(ref convex.entity.linearVelocity, dt, out velocity);
                ...
                if (minimumRadius * minimumRadius < velocitySquared)
                {
                    ...
                    BepuVector3 terrainUp = new BepuVector3(terrain.worldTransform.LinearTransform.M21, terrain.worldTransform.LinearTransform.M22, terrain.worldTransform.LinearTransform.M23);
                    ...
                    for (int i = 0; i < TerrainManifold.overlappedTriangles.Count; i++)
                    {
                            ...
                            rayHit.T > Toolbox.BigEpsilon)
                        {
                            ...
                            Fix64 dot;
                            BepuVector3.Dot(ref normal, ref terrainUp, out dot);
                            if (dot < F64.C0)
