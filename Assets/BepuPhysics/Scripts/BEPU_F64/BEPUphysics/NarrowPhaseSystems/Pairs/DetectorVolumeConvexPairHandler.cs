...
namespace BEPUphysics.NarrowPhaseSystems.Pairs
{
    ...
    public class DetectorVolumeConvexPairHandler : DetectorVolumePairHandler
    {
        ...
        public override void UpdateCollision(Fix64 dt)
        {
            ...
            var transform = new RigidTransform { Orientation = BepuQuaternion.Identity };
            ...
            for (int i = 0; i < overlaps.Count; i++)
            {
                ...
                BepuVector3.Add(ref triangle.vA, ref triangle.vB, out transform.Position);
                BepuVector3.Add(ref triangle.vC, ref transform.Position, out transform.Position);
                BepuVector3.Multiply(ref transform.Position, F64.OneThird, out transform.Position);
                BepuVector3.Subtract(ref triangle.vA, ref transform.Position, out triangle.vA);
                BepuVector3.Subtract(ref triangle.vB, ref transform.Position, out triangle.vB);
                BepuVector3.Subtract(ref triangle.vC, ref transform.Position, out triangle.vC);
