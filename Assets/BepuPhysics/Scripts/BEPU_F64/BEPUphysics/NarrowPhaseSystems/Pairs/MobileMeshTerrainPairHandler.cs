...
namespace BEPUphysics.NarrowPhaseSystems.Pairs
{
    ...
    public class MobileMeshTerrainPairHandler : MobileMeshMeshPairHandler
    {
        ...
        protected override TriangleCollidable GetOpposingCollidable(int index)
        {
            ...
            BepuVector3 terrainUp = new BepuVector3(mesh.worldTransform.LinearTransform.M21, mesh.worldTransform.LinearTransform.M22, mesh.worldTransform.LinearTransform.M23);
            Fix64 dot;
            BepuVector3 AB, AC, normal;
            ...
            toReturn.worldTransform.Orientation = BepuQuaternion.Identity;
            toReturn.UpdateBoundingBoxInternal(F64.C0);

            BepuVector3.Subtract(ref shape.vB, ref shape.vA, out AB);
            BepuVector3.Subtract(ref shape.vC, ref shape.vA, out AC);
            BepuVector3.Cross(ref AB, ref AC, out normal);
            BepuVector3.Dot(ref terrainUp, ref normal, out dot);
            if (dot > F64.C0)
            {
        ...
        protected override void UpdateContainedPairs(Fix64 dt)
        {
            ...
            BepuVector3 sweep;
            BepuVector3.Multiply(ref mobileMesh.entity.linearVelocity, dt, out sweep);
