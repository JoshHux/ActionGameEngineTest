...
namespace BEPUphysics.EntityStateManagement
{
    ...
    public class InterpolatedStatesManager : MultithreadedProcessingStage
    {
        ...
        void UpdateIndex(int i)
        {
            ...
            BepuVector3.Lerp(ref manager.ReadBuffers.backBuffer[i].Position, ref entity.position, blendAmount, out backBuffer[i].Position);
            BepuQuaternion.Slerp(ref manager.ReadBuffers.backBuffer[i].Orientation, ref entity.orientation, blendAmount, out backBuffer[i].Orientation);
        }
