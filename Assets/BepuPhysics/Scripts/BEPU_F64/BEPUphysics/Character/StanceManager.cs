...
namespace BEPUphysics.Character
{
    ...
    public class StanceManager
    {
        ...
        private void PrepareQueryObject(EntityCollidable queryObject, ref BepuVector3 position)
        {
        ...
        public bool CheckTransition(Stance targetStance, out Fix64 newHeight, out BepuVector3 newPosition)
        {
            ...
            if (CurrentStance != targetStance)
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        {
                            BepuVector3 candidatePosition = currentPosition + currentOffset * down;
                            Fix64 hintOffset;
        ...
        public bool UpdateStance(out BepuVector3 newPosition)
        {
            Fix64 newHeight;
        ...
        CharacterContactPositionState TrySupportLocation(ConvexCollidable<CylinderShape> queryObject, ref BepuVector3 position, out Fix64 hintOffset,
