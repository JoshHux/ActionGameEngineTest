...
namespace BEPUphysics.CollisionTests.CollisionAlgorithms
{
    ...
    public static class BoxSphereTester
    {
        ...
        public static bool AreShapesColliding(BoxShape box, SphereShape sphere, ref RigidTransform boxTransform, ref BepuVector3 spherePosition, out ContactData contact)
        {
            contact = new ContactData();

            BepuVector3 localPosition;
            RigidTransform.TransformByInverse(ref spherePosition, ref boxTransform, out localPosition);
#if !WINDOWS
            BepuVector3 localClosestPoint = new BepuVector3();
#else
            BepuVector3 localClosestPoint;
#endif
            ...
            BepuVector3 offset;
            BepuVector3.Subtract(ref spherePosition, ref contact.Position, out offset);
            ...
            if (offsetLength > Toolbox.Epsilon)
            {
                ...
                //Outside of the box.
                BepuVector3.Divide(ref offset, offsetLength, out contact.Normal);
                contact.PenetrationDepth = sphere.collisionMargin - offsetLength;
            }
            else
            {
                //Inside of the box.
                BepuVector3 penetrationDepths;
                ...
                BepuQuaternion.Transform(ref contact.Normal, ref boxTransform.Orientation, out contact.Normal);
            }
