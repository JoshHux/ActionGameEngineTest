...
namespace BEPUphysics.CollisionTests.CollisionAlgorithms
{
    ...
    public static class MinkowskiToolbox
    {
        ...
        public static void GetLocalMinkowskiExtremePoint(ConvexShape shapeA, ConvexShape shapeB, ref BepuVector3 direction, ref RigidTransform localTransformB, out BepuVector3 extremePoint)
        {
            ...
            BepuVector3 v;
            BepuVector3 negativeN;
            BepuVector3.Negate(ref direction, out negativeN);
            shapeB.GetExtremePointWithoutMargin(negativeN, ref localTransformB, out v);
            BepuVector3.Subtract(ref extremePoint, ref v, out extremePoint);

            ExpandMinkowskiSum(shapeA.collisionMargin, shapeB.collisionMargin, ref direction, out v);
            BepuVector3.Add(ref extremePoint, ref v, out extremePoint);
        ...
        ///<param name="extremePoint">The extreme point in the local space of A.</param>
        public static void GetLocalMinkowskiExtremePoint(ConvexShape shapeA, ConvexShape shapeB, ref BepuVector3 direction, ref RigidTransform localTransformB,
                                                 out BepuVector3 extremePointA, out BepuVector3 extremePoint)
        {
            //Extreme point of A-B along D = (extreme point of A along D) - (extreme point of B along -D)
            shapeA.GetLocalExtremePointWithoutMargin(ref direction, out extremePointA);
            BepuVector3 v;
            BepuVector3.Negate(ref direction, out v);
            BepuVector3 extremePointB;
            ...
            BepuVector3.Subtract(ref extremePointA, ref extremePointB, out extremePoint);
        ...
        ///<param name="extremePoint">The extreme point in the local space of A.</param>
        public static void GetLocalMinkowskiExtremePoint(ConvexShape shapeA, ConvexShape shapeB, ref BepuVector3 direction, ref RigidTransform localTransformB,
                                                 out BepuVector3 extremePointA, out BepuVector3 extremePointB, out BepuVector3 extremePoint)
        {
            //Extreme point of A-B along D = (extreme point of A along D) - (extreme point of B along -D)
            shapeA.GetLocalExtremePointWithoutMargin(ref direction, out extremePointA);
            BepuVector3 v;
        ...
        ///<param name="localTransformB">Transform of shapeB in the local space of A.</param>
        ///<param name="extremePoint">The extreme point in the local space of A.</param>
        public static void GetLocalMinkowskiExtremePointWithoutMargin(ConvexShape shapeA, ConvexShape shapeB, ref BepuVector3 direction, ref RigidTransform localTransformB, out BepuVector3 extremePoint)
        {
            //Extreme point of A-B along D = (extreme point of A along D) - (extreme point of B along -D)
            shapeA.GetLocalExtremePointWithoutMargin(ref direction, out extremePoint);
            BepuVector3 extremePointB;
            ...
            BepuVector3.Subtract(ref extremePoint, ref extremePointB, out extremePoint);
        ...
        public static void ExpandMinkowskiSum(Fix64 marginA, Fix64 marginB, ref BepuVector3 direction, out BepuVector3 contribution)
        {
            ...
            if (lengthSquared > Toolbox.Epsilon)
            {
                ...
                BepuVector3.Multiply(ref direction, (marginA + marginB) / Fix64.Sqrt(lengthSquared), out contribution);

            }
            else
            {
                contribution = new BepuVector3();
            }
        ...
        public static void ExpandMinkowskiSum(Fix64 marginA, Fix64 marginB, BepuVector3 direction, ref BepuVector3 toExpandA, ref BepuVector3 toExpandB)
        {
            Fix64 lengthSquared = direction.LengthSquared();
            if (lengthSquared > Toolbox.Epsilon)
            {
                ...
                BepuVector3.Multiply(ref direction, marginA * lengthSquared, out contribution);
                BepuVector3.Add(ref toExpandA, ref contribution, out toExpandA);
                BepuVector3.Multiply(ref direction, marginB * lengthSquared, out contribution);
                BepuVector3.Subtract(ref toExpandB, ref contribution, out toExpandB);
            }
