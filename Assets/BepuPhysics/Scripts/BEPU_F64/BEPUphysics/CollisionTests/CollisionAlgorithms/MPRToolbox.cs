...
namespace BEPUphysics.CollisionTests.CollisionAlgorithms
{
    ...
    public static class MPRToolbox
    {
        ...
        public static bool GetOverlapPosition(ConvexShape shapeA, ConvexShape shapeB, ref RigidTransform transformA, ref RigidTransform transformB, out BepuVector3 position)
        {
        ...
        /// <returns>Whether or not the two shapes overlap.</returns>
        public static bool GetLocalOverlapPosition(ConvexShape shapeA, ConvexShape shapeB, ref RigidTransform localTransformB, out BepuVector3 position)
        {
            return GetLocalOverlapPosition(shapeA, shapeB, ref localTransformB.Position, ref localTransformB, out position);
        }

        internal static bool GetLocalOverlapPosition(ConvexShape shapeA, ConvexShape shapeB, ref BepuVector3 originRay, ref RigidTransform localTransformB, out BepuVector3 position)
        {
            ...
            BepuVector3 v0;
            BepuVector3.Negate(ref originRay, out v0); //Since we're in A's local space, A-B is just -B.
            ...
            BepuVector3 n = originRay;
            BepuVector3 v1;
            BepuVector3 v1A, v1B; //extreme point contributions from each shape.  Used later to compute contact position; could be used to cache simplex too.
            ...
            BepuVector3 v2;
            BepuVector3 v2A, v2B;
            BepuVector3.Cross(ref v1, ref v0, out n);
            if (n.LengthSquared() < Toolbox.Epsilon)
            {
                ...
                Fix64 dot;
                BepuVector3.Dot(ref v1, ref originRay, out dot);
                if (dot < F64.C0)
                {
                    //Origin is outside.
                    position = new BepuVector3();
                ...
                BepuVector3.Dot(ref v0, ref originRay, out dotv0);
                Fix64 barycentricCoordinate = -dotv0 / (dot - dotv0);
                //BepuVector3.Subtract(ref v1A, ref v0A, out offset); //'v0a' is just the zero vector, so there's no need to calculate the offset.
                BepuVector3.Multiply(ref v1A, barycentricCoordinate, out position);
                return true;
            }
            MinkowskiToolbox.GetLocalMinkowskiExtremePoint(shapeA, shapeB, ref n, ref localTransformB, out v2A, out v2B, out v2);

            BepuVector3 temp1, temp2;
            //Set n for the first iteration.
            BepuVector3.Subtract(ref v1, ref v0, out temp1);
            BepuVector3.Subtract(ref v2, ref v0, out temp2);
            BepuVector3.Cross(ref temp1, ref temp2, out n);


            BepuVector3 v3A, v3B, v3;
            int count = 0;
            while (true)
            {
                ...
                BepuVector3.Cross(ref v1, ref v3, out temp1);
                Fix64 dot;
                BepuVector3.Dot(ref temp1, ref v0, out dot);
                if (dot < F64.C0)
                {
                    ...
                    BepuVector3.Subtract(ref v1, ref v0, out temp1);
                    BepuVector3.Subtract(ref v3, ref v0, out temp2);
                    BepuVector3.Cross(ref temp1, ref temp2, out n);
                    continue;
                }

                // If the origin is outside the plane defined by v3,v0,v2, then the portal is invalid.
                BepuVector3.Cross(ref v3, ref v2, out temp1);
                BepuVector3.Dot(ref temp1, ref v0, out dot);
                if (dot < F64.C0)
                {
                    ...
                    v1B = v3B;
                    // Calculate the normal of the plane that will be used to find a new extreme point.
                    BepuVector3.Subtract(ref v2, ref v0, out temp1);
                    BepuVector3.Subtract(ref v3, ref v0, out temp2);
                    BepuVector3.Cross(ref temp1, ref temp2, out n);
                    continue;
                }
            ...
            while (true)
            {
                ...
                BepuVector3.Subtract(ref v3, ref v2, out temp1);
                BepuVector3.Subtract(ref v1, ref v2, out temp2);
                BepuVector3.Cross(ref temp1, ref temp2, out n);
                Fix64 dot;
                BepuVector3.Dot(ref n, ref v1, out dot);
                if (dot >= F64.C0)
                {
                    BepuVector3 temp3;
                    ...
                    BepuVector3.Subtract(ref v1, ref v0, out temp1);
                    BepuVector3.Subtract(ref v2, ref v0, out temp2);
                    BepuVector3.Subtract(ref v3, ref v0, out temp3);

                    BepuVector3 cross;
                    BepuVector3.Cross(ref temp1, ref temp2, out cross);
                    Fix64 v0v1v2v3volume;
                    BepuVector3.Dot(ref cross, ref temp3, out v0v1v2v3volume);

                    BepuVector3.Cross(ref v1, ref v2, out cross);
                    Fix64 ov1v2v3volume;
                    BepuVector3.Dot(ref cross, ref v3, out ov1v2v3volume);

                    BepuVector3.Cross(ref originRay, ref temp2, out cross);
                    Fix64 v0ov2v3volume;
                    BepuVector3.Dot(ref cross, ref temp3, out v0ov2v3volume);

                    BepuVector3.Cross(ref temp1, ref originRay, out cross);
                    Fix64 v0v1ov3volume;
                    BepuVector3.Dot(ref cross, ref temp3, out v0v1ov3volume);
                ...
                Fix64 dot2;
                BepuVector3.Dot(ref v4, ref n, out dot2);
                if (dot2 < F64.C0)
                {
                ...
                BepuVector3.Cross(ref v4, ref v0, out temp1);
                BepuVector3.Dot(ref v1, ref temp1, out dot);
                if (dot >= F64.C0)
                {
                    BepuVector3.Dot(ref v2, ref temp1, out dot);
                    if (dot >= F64.C0)
                    {
                ...
                {
                    BepuVector3.Dot(ref v3, ref temp1, out dot);
                    if (dot >= F64.C0)
                    {
        ...
        /// <param name="localTransformB">Relative transform of shape B to shape A.</param>
        /// <returns>Whether or not the shapes are overlapping.</returns>
        internal static bool AreLocalShapesOverlapping(ConvexShape shapeA, ConvexShape shapeB, ref BepuVector3 originRay, ref RigidTransform localTransformB)
        {
            //Compute the origin ray.  This points from a point known to be inside the minkowski sum to the origin.
            //The centers of the shapes are used to create the interior point.
        ...
        public static void LocalSurfaceCast(ConvexShape shapeA, ConvexShape shapeB, ref RigidTransform localTransformB, ref BepuVector3 direction, out Fix64 t, out BepuVector3 normal)
        {
            ...
            //Find another extreme point in a direction perpendicular to the previous.
            BepuVector3 v2;
            BepuVector3.Cross(ref direction, ref v1, out n);
            if (n.LengthSquared() < Toolbox.Epsilon)
            {
                //v1 and v0 could be parallel.
                //This isn't a bad thing- it means the direction is exactly aligned with the extreme point offset.
                ...
                if (rayLengthSquared > Toolbox.Epsilon * F64.C0p01)
                    BepuVector3.Divide(ref direction, Fix64.Sqrt(rayLengthSquared), out normal);
                else
                    normal = new BepuVector3();

                Fix64 rate;
                BepuVector3.Dot(ref  normal, ref direction, out rate);
                Fix64 distance;
                BepuVector3.Dot(ref  normal, ref v1, out distance);
                if (rate > F64.C0)
                    t = distance / rate;
                else
                    t = F64.C0;
            ...
            BepuVector3 temp1, temp2;
            //Set n for the first iteration.
            BepuVector3.Cross(ref v1, ref v2, out n);
            ...
            while (true)
            {
                ...
                BepuVector3.Cross(ref v1, ref v3, out temp1);
                BepuVector3.Dot(ref temp1, ref direction, out dot);
                if (dot < F64.C0)
                {
                    //Replace the point that was on the inside of the plane (v2) with the new extreme point.
                    v2 = v3;
                    // Calculate the normal of the plane that will be used to find a new extreme point.
                    BepuVector3.Cross(ref v1, ref v3, out n);
                    continue;
                }
                ...
                if (dot < F64.C0)
                {
                    ...
                    v1 = v3;
                    // Calculate the normal of the plane that will be used to find a new extreme point.
                    BepuVector3.Cross(ref v2, ref v3, out n);
                    continue;
                }
                break;
            }
            ...
            {
                //Compute the outward facing normal.
                BepuVector3.Subtract(ref v1, ref v2, out temp1);
                BepuVector3.Subtract(ref v3, ref v2, out temp2);
                BepuVector3.Cross(ref temp1, ref temp2, out n);
                ...
                BepuVector3.Dot(ref n, ref v1, out dot);
                Fix64 supportDot;
                BepuVector3.Dot(ref v4, ref n, out supportDot);
                ...
                if (supportDot - dot < surfaceEpsilon || count > MPRToolbox.InnerIterationLimit) // TODO: Could use a dynamic epsilon for possibly better behavior.
                {
                    ...
                    //BepuVector3.Multiply(ref normal, normalLengthInverse, out normal);
                    ...
                    {
                        BepuVector3.Divide(ref n, Fix64.Sqrt(lengthSquared), out normal);

                        //The plane is very close to the surface, and the ray is known to pass through it.
                        //dot is the rate.
                        BepuVector3.Dot(ref normal, ref direction, out dot);
                        //supportDot is the distance to the plane.
                        BepuVector3.Dot(ref normal, ref v1, out supportDot);
                        if (dot > F64.C0)
                            t = supportDot / dot;
                        else
                            t = F64.C0;
                ...
                BepuVector3.Cross(ref v4, ref direction, out temp1);
                BepuVector3.Dot(ref v1, ref temp1, out dot);
                if (dot >= F64.C0)
                {
                    BepuVector3.Dot(ref v2, ref temp1, out dot);
                ...
                //BepuVector3.Cross(ref v1, ref v4, out temp1);
                //BepuVector3.Dot(ref temp1, ref direction, out dot);
                //if (dot > 0)
                //{
                //    BepuVector3.Cross(ref v2, ref v4, out temp2);
                //    BepuVector3.Dot(ref temp2, ref direction, out dot);
                //    if (dot > 0)
                //    {
                ...
                //else
                //{
                //    BepuVector3.Cross(ref v3, ref v4, out temp2);
                //    BepuVector3.Dot(ref temp2, ref direction, out dot);
                //    if (dot > 0)
                //    {
        ...
        public static void LocalSurfaceCast(ConvexShape shapeA, ConvexShape shapeB, ref RigidTransform localTransformB, ref BepuVector3 direction, out Fix64 t, out BepuVector3 normal, out BepuVector3 position)
        {
            // Local surface cast is very similar to regular MPR.  However, instead of starting at an interior point and targeting the origin,
            // the ray starts at the origin (a point known to be in both shape and shapeB), and just goes towards the direction until the surface
            // is found.  The portal (v1, v2, v3) at termination defines the surface normal, and the distance from the origin to the portal along the direction is used as the 't' result.
            ...
            while (true)
            {
                ...
                if (supportDot - dot < surfaceEpsilon || count > MPRToolbox.InnerIterationLimit) // TODO: Could use a dynamic epsilon for possibly better behavior.
                {
                    ...
                    BepuVector3.Multiply(ref direction, t, out position);

                    Toolbox.GetBarycentricCoordinates(ref position, ref v1, ref v2, ref v3, out v1Weight, out v2Weight, out v3Weight);
                    BepuVector3.Multiply(ref v1A, v1Weight, out position);
                    BepuVector3 temp;
                    BepuVector3.Multiply(ref v2A, v2Weight, out temp);
                    BepuVector3.Add(ref temp, ref position, out position);
                    BepuVector3.Multiply(ref v3A, v3Weight, out temp);
                    BepuVector3.Add(ref temp, ref position, out position);
                    ////DEBUG STUFF:
        ...
        static bool VerifySimplex(ref BepuVector3 v0, ref BepuVector3 v1, ref BepuVector3 v2, ref BepuVector3 v3, ref BepuVector3 direction)
        {


            //v1, v0, v3
            BepuVector3 cross = BepuVector3.Cross(v0 - v1, v3 - v1);
            Fix64 planeProduct1 = BepuVector3.Dot(cross, direction);
            //v3, v0, v2
            cross = BepuVector3.Cross(v0 - v3, v2 - v3);
            Fix64 planeProduct2 = BepuVector3.Dot(cross, direction);
            //v2, v0, v1
            cross = BepuVector3.Cross(v0 - v2, v1 - v2);
            Fix64 planeProduct3 = BepuVector3.Dot(cross, direction);
        ...
        public static bool GetContact(ConvexShape shapeA, ConvexShape shapeB, ref RigidTransform transformA, ref RigidTransform transformB, ref BepuVector3 penetrationAxis, out ContactData contact)
        {
            RigidTransform localTransformB;
            MinkowskiToolbox.GetLocalTransform(ref transformA, ref transformB, out localTransformB);
            if (MPRToolbox.AreLocalShapesOverlapping(shapeA, shapeB, ref localTransformB))
            {
                ...
                BepuVector3 rayCastDirection;
                Fix64 lengthSquared = penetrationAxis.LengthSquared();
                if (lengthSquared > Toolbox.Epsilon)
                {
                    BepuVector3.Divide(ref penetrationAxis, Fix64.Sqrt(lengthSquared), out rayCastDirection);// (BepuVector3.Normalize(localDirection) + BepuVector3.Normalize(collidableB.worldTransform.Position - collidableA.worldTransform.Position)) / 2;
                ...
                BepuVector3 normalCandidate;
                Fix64 depthCandidate;
                lengthSquared = localTransformB.Position.LengthSquared();
                if (lengthSquared > Toolbox.Epsilon)
                {
                    BepuVector3.Divide(ref localTransformB.Position, Fix64.Sqrt(lengthSquared), out rayCastDirection);
                ...
                Matrix3x3.CreateFromBepuQuaternion(ref transformA.Orientation, out orientation);
                Matrix3x3.Transform(ref contact.Normal, ref orientation, out contact.Normal);
                //BepuVector3.Negate(ref contact.Normal, out contact.Normal);
                Matrix3x3.Transform(ref contact.Position, ref orientation, out contact.Position);
                BepuVector3.Add(ref contact.Position, ref transformA.Position, out contact.Position);
                return true;
            }
        ...
        public static void RefinePenetration(ConvexShape shapeA, ConvexShape shapeB, ref RigidTransform localTransformB, Fix64 initialDepth, ref BepuVector3 initialNormal, out Fix64 penetrationDepth, out BepuVector3 refinedNormal, out BepuVector3 position)
        {
            //The local casting can optionally continue.  Eventually, it will converge to the local minimum.
        ...
        public static bool Sweep(ConvexShape shapeA, ConvexShape shapeB, ref BepuVector3 sweepA, ref BepuVector3 sweepB, ref RigidTransform transformA, ref RigidTransform transformB, out RayHit hit)
        {
            ...
            BepuVector3.Subtract(ref sweepA, ref sweepB, out velocityWorld);
            BepuQuaternion conjugateOrientationA;
            BepuQuaternion.Conjugate(ref transformA.Orientation, out conjugateOrientationA);
            BepuVector3 localDirection;
            BepuQuaternion.Transform(ref velocityWorld, ref conjugateOrientationA, out localDirection);
            ...
            if (rayLengthSquared > Toolbox.Epsilon * F64.C0p01)
            {
                BepuVector3.Dot(ref localTransformB.Position, ref localDirection, out sweepLength);
            ...
            BepuVector3 sweep;
            BepuVector3.Multiply(ref localDirection, sweepLength, out sweep);
            ...
            if (negativeLength)
            {
                ...
                hit.T = F64.C0;
                BepuVector3.Normalize(ref localDirection, out hit.Normal);
                BepuQuaternion.Transform(ref hit.Normal, ref transformA.Orientation, out hit.Normal);
                //hit.Location = hit.T * localDirection;
                BepuQuaternion.Transform(ref hit.Location, ref transformA.Orientation, out hit.Location);
            ...
            if (LocalSweepCast(shapeA, shapeB, sweepLength, rayLengthSquared, ref localDirection, ref sweep, ref localTransformB, out hit))
            {
                ...
                BepuVector3 minkowskiRayHit = -hit.T * localDirection;
                ...
                BepuVector3 temp;
                BepuVector3.Multiply(ref sweepA, hit.T, out temp);
                BepuVector3.Add(ref temp, ref hit.Location, out hit.Location);
                return true;
            }
            return false;
        ...
        private static bool LocalSweepCast(ConvexShape shape, ConvexShape shapeB, Fix64 sweepLength, Fix64 rayLengthSquared, ref BepuVector3 localDirection, ref BepuVector3 sweep, ref RigidTransform localTransformB, out RayHit hit)
        {
            ...
            //{
            //    hit.T = 0;
            //    BepuVector3.Normalize(ref n, out hit.Normal);
            //    BepuVector3.Transform(ref hit.Normal, ref transform.Orientation, out hit.Normal);
            //    //hit.Location = hit.T * localDirection;
            //    BepuVector3.Transform(ref hit.Location, ref transform.Orientation, out hit.Location);
            //    BepuVector3.Add(ref hit.Location, ref transform.Position, out hit.Location);
            //    hit.Location += sweepA * hit.T;
            //    return true;
            //}
            ...
            //Find another extreme point in a direction perpendicular to the previous.
            BepuVector3 v2, v2A;
            BepuVector3.Cross(ref localDirection, ref v1, out n);
            hit.Location = new BepuVector3();
            if (n.LengthSquared() < Toolbox.Epsilon * F64.C0p01)
            {
                ...
                if (rayLengthSquared > Toolbox.Epsilon * F64.C0p01)
                    BepuVector3.Divide(ref localDirection, Fix64.Sqrt(rayLengthSquared), out hit.Normal);
                else
                    hit.Normal = new BepuVector3();

                Fix64 rate;
                BepuVector3.Dot(ref  hit.Normal, ref localDirection, out rate);
                Fix64 distance;
                BepuVector3.Dot(ref  hit.Normal, ref v1, out distance);
                if (rate > F64.C0)
            ...
            //relative to the direction vector.
            Fix64 dot;
            BepuVector3.Dot(ref n, ref localDirection, out dot);
            if (dot > F64.C0)
            {
                //It's not properly calibrated.  Flip the winding (and the previously calculated normal).
                BepuVector3.Negate(ref n, out n);
            ...
            while (true)
            {
                ...
                // If the direction is outside the plane defined by v1,v0,v3, then the portal is invalid.
                BepuVector3.Cross(ref v1, ref v3, out temp1);
                BepuVector3.Dot(ref temp1, ref localDirection, out dot);
                if (dot < F64.C0)
                {
                    //Replace the point that was on the inside of the plane (v2) with the new extreme point.
                    v2 = v3;
            ...
            while (true)
            {
                ...
                if (supportDot - dot < rayCastSurfaceEpsilon || count > MPRToolbox.InnerIterationLimit) // TODO: Could use a dynamic epsilon for possibly better behavior.
                {
                    ...
                    {
                        BepuVector3.Divide(ref n, Fix64.Sqrt(lengthSquared), out hit.Normal);

                        //The plane is very close to the surface, and the ray is known to pass through it.
                        //dot is the rate.
                        BepuVector3.Dot(ref  hit.Normal, ref localDirection, out dot);
                        //supportDot is the distance to the plane.
                        BepuVector3.Dot(ref  hit.Normal, ref v1, out supportDot);
                    ...
                    //BepuVector3 mdHitLocation = t * localDirection;
                    //Fix64 v1Weight, v2Weight, v3Weight;
                ...
                //This v4 x direction is just a minor reordering of a scalar triple product: (v1 x v4) * direction.
                //It eliminates the need for extra cross products for the inner if.
                BepuVector3.Cross(ref v4, ref localDirection, out temp1);
                BepuVector3.Dot(ref v1, ref temp1, out dot);
                if (dot >= F64.C0)
                {
                    BepuVector3.Dot(ref v2, ref temp1, out dot);
        ...
        internal static void GetLocalPosition(ConvexShape shapeA, ConvexShape shapeB, ref RigidTransform localTransformB, ref BepuVector3 minkowskiPosition, out BepuVector3 position)
        {
            ...
            BepuVector3.Add(ref minkowskiPosition, ref localTransformB.Position, out rayDirection);
            ...
            BepuVector3 v0;
            BepuVector3.Negate(ref localTransformB.Position, out v0); //Since we're in A's local space, A-B is just -B.
            ...
            if (n.LengthSquared() < Toolbox.Epsilon)
            {
                ...
                Fix64 dot = BepuVector3.Dot(v1 - minkowskiPosition, rayDirection);
                //BepuVector3.Dot(ref v1, ref rayDirection, out dot);
                ...
                //Origin is inside.
                //Compute barycentric coordinates along simplex (segment).
                Fix64 dotv0 = BepuVector3.Dot(v0 - minkowskiPosition, rayDirection);
                //Dot > 0, so dotv0 starts out negative.
                //BepuVector3.Dot(ref v0, ref rayDirection, out dotv0);
                Fix64 barycentricCoordinate = -dotv0 / (dot - dotv0);
                //BepuVector3.Subtract(ref v1A, ref v0A, out offset); //'v0a' is just the zero vector, so there's no need to calculate the offset.
                BepuVector3.Multiply(ref v1A, barycentricCoordinate, out position);
                BepuVector3 offset;
                BepuVector3.Subtract(ref v1B, ref localTransformB.Position, out offset);
                return;
            }
            MinkowskiToolbox.GetLocalMinkowskiExtremePoint(shapeA, shapeB, ref n, ref localTransformB, out v2A, out v2B, out v2);

            BepuVector3 temp;
            BepuVector3 v0v1, v0v2;
            //Set n for the first iteration.
            BepuVector3.Subtract(ref v1, ref v0, out v0v1);
            BepuVector3.Subtract(ref v2, ref v0, out v0v2);
            BepuVector3.Cross(ref v0v1, ref v0v2, out n);

            BepuVector3 pointToV0;
            BepuVector3.Subtract(ref v0, ref minkowskiPosition, out pointToV0);
            BepuVector3 v3A, v3B, v3;
            int count = 0;
            while (true)
            {
                ...
                BepuVector3 v0v3;
                BepuVector3.Subtract(ref v1, ref v0, out v0v1);
                BepuVector3.Subtract(ref v3, ref v0, out v0v3);
                BepuVector3.Cross(ref v0v1, ref v0v3, out temp);
                Fix64 dot;
                BepuVector3.Dot(ref temp, ref pointToV0, out dot);
                if (dot < F64.C0)
                {
                    //Replace the point that was on the inside of the plane (v2) with the new extreme point.
                    v2 = v3;
                    ...
                    v2B = v3B;
                    // Calculate the normal of the plane that will be used to find a new extreme point.
                    BepuVector3.Cross(ref v0v1, ref v0v3, out n);
                    continue;
                }

                // If the origin is outside the plane defined by v3,v0,v2, then the portal is invalid.
                BepuVector3.Subtract(ref v2, ref v0, out v0v2);
                BepuVector3.Cross(ref v0v3, ref v0v2, out temp);
                BepuVector3.Dot(ref temp, ref pointToV0, out dot);
                if (dot < F64.C0)
                {
                    //Replace the point that was on the inside of the plane (v1) with the new extreme point.
                    ...
                    v1B = v3B;
                    // Calculate the normal of the plane that will be used to find a new extreme point.
                    BepuVector3.Cross(ref v0v2, ref v0v3, out n);
                    continue;
                }
                break;
            }
            ...
            while (true)
            {
                //Test the origin against the plane defined by v1, v2, v3.  If it's inside, we're done.
                //Compute the outward facing normal.
                BepuVector3 v2v3, v2v1;
                BepuVector3.Subtract(ref v3, ref v2, out v2v3);
                BepuVector3.Subtract(ref v1, ref v2, out v2v1);
                BepuVector3.Cross(ref v2v3, ref v2v1, out n);
                Fix64 dot;
                BepuVector3 pointToV1;
                BepuVector3.Subtract(ref v1, ref minkowskiPosition, out pointToV1);
                BepuVector3.Dot(ref pointToV1, ref n, out dot);
                ...
                //    BepuVector3.Cross(ref rayDirection, ref temp2, out cross);
                //    Fix64 v0ov2v3volume;
                //    BepuVector3.Dot(ref cross, ref temp3, out v0ov2v3volume);

                //    BepuVector3.Cross(ref temp1, ref rayDirection, out cross);
                //    Fix64 v0v1ov3volume;
                //    BepuVector3.Dot(ref cross, ref temp3, out v0v1ov3volume);
                ...
                //If the origin is further along the direction than the extreme point, it's not inside the shape.
                Fix64 dot2;
                BepuVector3 pointToV4;
                BepuVector3.Subtract(ref v4, ref minkowskiPosition, out pointToV4);
                BepuVector3.Dot(ref pointToV4, ref n, out dot2);
                ...
                if (dot2 - dot < rayCastSurfaceEpsilon || count > MPRToolbox.InnerIterationLimit) // TODO: Could use a dynamic epsilon for possibly better behavior.
                {
                    ...
                    BepuVector3.Multiply(ref v1A, weight1, out position);
                    BepuVector3.Multiply(ref v2A, weight2, out v2A);
                    BepuVector3.Multiply(ref v3A, weight3, out v3A);
                    BepuVector3.Add(ref v2A, ref position, out position);
                    BepuVector3.Add(ref v3A, ref position, out position);
                ...
                BepuVector3.Cross(ref pointToV4, ref pointToV0, out temp);
                BepuVector3.Dot(ref pointToV1, ref temp, out dot);
                if (dot >= F64.C0) //Dot v0 x v4 against v1, and dot it against 
                {
                    BepuVector3 pointToV2;
                    BepuVector3.Subtract(ref v2, ref minkowskiPosition, out pointToV2);
                    BepuVector3.Dot(ref pointToV2, ref temp, out dot);
                    if (dot >= F64.C0)
                    {
                        v1 = v4; // Inside v1 & inside v2 ==> eliminate v1
                        v1A = v4A;
                ...
                {
                    BepuVector3 pointToV3;
                    BepuVector3.Subtract(ref v3, ref minkowskiPosition, out pointToV3);
                    BepuVector3.Dot(ref pointToV3, ref temp, out dot);
                    if (dot >= F64.C0)
                    {
                        v2 = v4; // Outside v1 & inside v3 ==> eliminate v2
                        v2A = v4A;
        ...
        public static bool AreSweptShapesIntersecting(ConvexShape shapeA, ConvexShape shapeB, ref BepuVector3 sweep, ref RigidTransform localTransformB, out BepuVector3 position)
        {
            //It's possible that the two objects' centers are overlapping, or very very close to it.  In this case, 
            //they are obviously colliding and we can immediately exit.
            ...
            //This implementation is similar to that of the original XenoCollide.
            //'n' will be the direction used to find supports throughout the algorithm.
            BepuVector3 n = localTransformB.Position;
            BepuVector3 v1;
            BepuVector3 v1A; //extreme point contributions from each shape.  Used later to compute contact position; could be used to cache simplex too.
            ...
            if (n.LengthSquared() < Toolbox.Epsilon)
            {
                ...
                //If the origin is within this extreme point, then there is an intersection.
                Fix64 dot;
                BepuVector3.Dot(ref v1, ref localTransformB.Position, out dot);
                if (dot < F64.C0)
                {
                    //Origin is outside.
                    position = new BepuVector3();
                ...
                Fix64 dotv0;
                //Dot > 0, so dotv0 starts out negative.
                BepuVector3.Dot(ref v0, ref localTransformB.Position, out dotv0);
                Fix64 barycentricCoordinate = -dotv0 / (dot - dotv0);
                //BepuVector3.Subtract(ref v1A, ref v0A, out offset); //'v0a' is just the zero vector, so there's no need to calculate the offset.
                BepuVector3.Multiply(ref v1A, barycentricCoordinate, out position);
                return true;
            ...
            while (true)
            {
                ...
                if (dot >= F64.C0)
                {
                    ...
                    BepuVector3.Cross(ref localTransformB.Position, ref temp2, out cross);
                    Fix64 v0ov2v3volume;
                    BepuVector3.Dot(ref cross, ref temp3, out v0ov2v3volume);

                    BepuVector3.Cross(ref temp1, ref localTransformB.Position, out cross);
                    Fix64 v0v1ov3volume;
                    BepuVector3.Dot(ref cross, ref temp3, out v0v1ov3volume);
        ...
        static void GetSweptExtremePoint(ConvexShape shapeA, ConvexShape shapeB, ref RigidTransform localTransformB, ref BepuVector3 sweep, ref BepuVector3 extremePointDirection, out BepuVector3 extremePointA, out BepuVector3 extremePoint)
        {
            BepuVector3 b;
            ...
            Fix64 dot;
            BepuVector3.Dot(ref extremePointDirection, ref sweep, out dot);
            if (dot > F64.C0)
            {
                BepuVector3.Add(ref extremePoint, ref sweep, out extremePoint);
            }
        }
        ...
        public static bool RayCast(Ray ray, Fix64 maximumLength, ConvexShape shape, ref RigidTransform transform, out RayHit hit)
        {
            ...
            BepuVector3.Negate(ref localRay.Direction, out localRay.Direction);
            ...
            if (Toolbox.RayCastSphere(ref ray, ref transform.Position, shape.MaximumRadius, maximumLength, out sphereHit))
            {
                ...
                BepuVector3 offset;
                BepuVector3.Multiply(ref localRay.Direction, -sphereHit.T, out offset);
                BepuVector3.Add(ref localRay.Position, ref offset, out localRay.Position);
            }
            else
            {
            ...
            if (rayLengthSquared > Toolbox.Epsilon * F64.C0p01)
            {
                BepuVector3.Dot(ref localRay.Position, ref localRay.Direction, out sweepLength);
            ...
            BepuVector3 sweep;
            BepuVector3.Multiply(ref localRay.Direction, sweepLength, out sweep);
            //Check to see if the origin is contained within the swept shape.
            ...
            if (negativeLength)
            {
                ...
                hit.T = F64.C0;
                BepuVector3.Normalize(ref ray.Direction, out hit.Normal);
        ...
        public static bool SweptShapeContainsPoint(ConvexShape shape, ref BepuVector3 sweep, ref BepuVector3 localPoint)
        {
            //It's possible that the two objects' centers are overlapping, or very very close to it.  In this case, 
            //they are obviously colliding and we can immediately exit.
            ...
            BepuVector3 v0;
            BepuVector3.Negate(ref localPoint, out v0); //Since we're in A's local space, A-B is just -B.
            ...
            if (n.LengthSquared() < Toolbox.Epsilon)
            {
                ...
                //If the origin is within this extreme point, then there is an intersection.
                Fix64 dot;
                BepuVector3.Dot(ref v1, ref localPoint, out dot);
                if (dot < F64.C0)
                {
                    //Origin is outside.
                    return false;
        ...
        private static bool LocalSweepCast(ConvexShape shape, Fix64 sweepLength, Fix64 rayLengthSquared, ref BepuVector3 localDirection, ref BepuVector3 sweep, ref BepuVector3 rayOrigin, out RayHit hit)
        {
            //By now, the ray is known to be within the swept shape and facing the right direction for a normal raycast.
        ...
        static void GetSweptExtremePoint(ConvexShape shape, ref BepuVector3 point, ref BepuVector3 sweep, ref BepuVector3 extremePointDirection, out BepuVector3 extremePoint)
        {
            shape.GetExtremePoint(extremePointDirection, ref Toolbox.RigidIdentity, out extremePoint);
            BepuVector3.Subtract(ref extremePoint, ref point, out extremePoint);
            Fix64 dot;
            BepuVector3.Dot(ref extremePointDirection, ref sweep, out dot);
            if (dot > F64.C0)
            {
