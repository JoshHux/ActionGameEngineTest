...
namespace BEPUphysics.CollisionTests.CollisionAlgorithms.GJK
{
    ...
    public struct RaySimplex
    {
        ...
        public bool GetPointClosestToOrigin(ref RaySimplex simplex, out BepuVector3 point)
        {
        ...
        public void GetPointOnSegmentClosestToOrigin(ref RaySimplex simplex, out BepuVector3 point)
        {
        ...
        public void GetPointOnTriangleClosestToOrigin(ref RaySimplex simplex, out BepuVector3 point)
        {
            BepuVector3 ab, ac;
        ...
        public bool GetPointOnTetrahedronClosestToOrigin(ref RaySimplex simplex, out BepuVector3 point)
        {
        ...
        private static bool TryTetrahedronTriangle(ref BepuVector3 A, ref BepuVector3 B, ref BepuVector3 C,
                                                   ref BepuVector3 simplexA, ref BepuVector3 simplexB, ref BepuVector3 simplexC,
                                                   ref BepuVector3 otherPoint, out RaySimplex simplex, out BepuVector3 point)
        {
            ...
            if (AdotN * ADdotN >= F64.C0)
            {
                ...
                if (va <= F64.C0 && (d3d4 = BdotAC - BdotAB) > F64.C0 && (d6d5 = CdotAB - CdotAC) > F64.C0)//Note > instead of >= and < instead of <=; prevents bad denominator
                {
                    ...
                    BepuVector3 bc;
                    BepuVector3.Subtract(ref C, ref B, out bc);
                    BepuVector3.Multiply(ref bc, V, out point);
                    BepuVector3.Add(ref point, ref B, out point);
                    return true;
                }
        ...
        public void AddNewSimplexPoint(ref BepuVector3 point, ref BepuVector3 hitLocation, out RaySimplex shiftedSimplex)
        {
            ...
            switch (State)
            {
                case SimplexState.Empty:
                    ...
                    BepuVector3.Subtract(ref hitLocation, ref A, out shiftedSimplex.A);
                    break;
                case SimplexState.Point:
                    ...
                    BepuVector3.Subtract(ref hitLocation, ref A, out shiftedSimplex.A);
                    BepuVector3.Subtract(ref hitLocation, ref B, out shiftedSimplex.B);
                    break;
                case SimplexState.Segment:
                    ...
                    BepuVector3.Subtract(ref hitLocation, ref A, out shiftedSimplex.A);
                    BepuVector3.Subtract(ref hitLocation, ref B, out shiftedSimplex.B);
                    BepuVector3.Subtract(ref hitLocation, ref C, out shiftedSimplex.C);
                    break;
                case SimplexState.Triangle:
                    ...
                    BepuVector3.Subtract(ref hitLocation, ref B, out shiftedSimplex.B);
                    BepuVector3.Subtract(ref hitLocation, ref C, out shiftedSimplex.C);
                    BepuVector3.Subtract(ref hitLocation, ref D, out shiftedSimplex.D);
                    break;
            }
        ...
        public Fix64 GetErrorTolerance(ref BepuVector3 rayOrigin)
        {
            switch (State)
            {
                case SimplexState.Point:
                    Fix64 distanceA;
                    BepuVector3.DistanceSquared(ref A, ref rayOrigin, out distanceA);
                    return distanceA;
                case SimplexState.Segment:
                    Fix64 distanceB;
                    BepuVector3.DistanceSquared(ref A, ref rayOrigin, out distanceA);
                    BepuVector3.DistanceSquared(ref B, ref rayOrigin, out distanceB);
                    return MathHelper.Max(distanceA, distanceB);
                case SimplexState.Triangle:
                    Fix64 distanceC;
                    BepuVector3.DistanceSquared(ref A, ref rayOrigin, out distanceA);
                    BepuVector3.DistanceSquared(ref B, ref rayOrigin, out distanceB);
                    BepuVector3.DistanceSquared(ref C, ref rayOrigin, out distanceC);
                ...
                case SimplexState.Tetrahedron:
                    ...
                    BepuVector3.DistanceSquared(ref B, ref rayOrigin, out distanceB);
                    BepuVector3.DistanceSquared(ref C, ref rayOrigin, out distanceC);
                    BepuVector3.DistanceSquared(ref D, ref rayOrigin, out distanceD);
