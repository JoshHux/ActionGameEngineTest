...
namespace BEPUphysics.CollisionTests.CollisionAlgorithms.GJK
{
    ...
    public struct CachedSimplex
    {
        ...
        //    BepuVector3.Negate(ref localTransformB.Position, out direction);
        //    BepuQuaternion conjugate;
        //    BepuQuaternion.Conjugate(ref localTransformB.Orientation, out conjugate);
        //    BepuVector3.Transform(ref direction, ref conjugate, out direction);
    ...
    {
        public BepuVector3 A;
        public BepuVector3 B;
        public BepuVector3 C;
        public BepuVector3 D;
    }
    ...
    public struct PairSimplex
    {
        ...
        private PairSimplex(ref RigidTransform localTransformB)
        {
            ...
            BepuVector3.Negate(ref localTransformB.Position, out A);
            B = new BepuVector3();
            C = new BepuVector3();
            D = new BepuVector3();
            U = F64.C0;
        ...
        public PairSimplex(ref CachedSimplex cachedSimplex, ref RigidTransform localTransformB)
        {
            ...
            switch (State)
            {
                case SimplexState.Point:
                    BepuQuaternion.Transform(ref cachedSimplex.LocalSimplexB.A, ref LocalTransformB.Orientation, out SimplexB.A);
                    BepuVector3.Add(ref SimplexB.A, ref LocalTransformB.Position, out SimplexB.A);

                    BepuVector3.Subtract(ref SimplexA.A, ref SimplexB.A, out A);
                    B = new BepuVector3();
                    C = new BepuVector3();
                    D = new BepuVector3();
                    break;
                case SimplexState.Segment:
                    Matrix3x3 transform;
                    Matrix3x3.CreateFromBepuQuaternion(ref localTransformB.Orientation, out transform);
                    ...
                    BepuVector3.Add(ref SimplexB.A, ref LocalTransformB.Position, out SimplexB.A);
                    BepuVector3.Add(ref SimplexB.B, ref LocalTransformB.Position, out SimplexB.B);

                    BepuVector3.Subtract(ref SimplexA.A, ref SimplexB.A, out A);
                    BepuVector3.Subtract(ref SimplexA.B, ref SimplexB.B, out B);
                    C = new BepuVector3();
                    D = new BepuVector3();

                    ////Test for degeneracy.
                    //Fix64 edgeLengthAB;
                    //BepuVector3.DistanceSquared(ref A, ref B, out edgeLengthAB);
                ...
                case SimplexState.Triangle:
                    ...
                    BepuVector3.Add(ref SimplexB.A, ref LocalTransformB.Position, out SimplexB.A);
                    BepuVector3.Add(ref SimplexB.B, ref LocalTransformB.Position, out SimplexB.B);
                    BepuVector3.Add(ref SimplexB.C, ref LocalTransformB.Position, out SimplexB.C);

                    BepuVector3.Subtract(ref SimplexA.A, ref SimplexB.A, out A);
                    BepuVector3.Subtract(ref SimplexA.B, ref SimplexB.B, out B);
                    BepuVector3.Subtract(ref SimplexA.C, ref SimplexB.C, out C);
                    D = new BepuVector3();
                    ...
                    //BepuVector3 cross;
                    //BepuVector3.Cross(ref AB, ref AC, out cross);
                ...
                case SimplexState.Tetrahedron:
                    ...
                    BepuVector3.Add(ref SimplexB.B, ref LocalTransformB.Position, out SimplexB.B);
                    BepuVector3.Add(ref SimplexB.C, ref LocalTransformB.Position, out SimplexB.C);
                    BepuVector3.Add(ref SimplexB.D, ref LocalTransformB.Position, out SimplexB.D);

                    BepuVector3.Subtract(ref SimplexA.A, ref SimplexB.A, out A);
                    BepuVector3.Subtract(ref SimplexA.B, ref SimplexB.B, out B);
                    BepuVector3.Subtract(ref SimplexA.C, ref SimplexB.C, out C);
                    BepuVector3.Subtract(ref SimplexA.D, ref SimplexB.D, out D);

                    ////Test for degeneracy.
                    //BepuVector3 AD;
                    //BepuVector3.Subtract(ref B, ref A, out AB);
                    //BepuVector3.Subtract(ref C, ref A, out AC);
                    //BepuVector3.Subtract(ref D, ref A, out AD);
                    //BepuVector3.Cross(ref AB, ref AC, out cross);
                    //Fix64 volume;
                    //BepuVector3.Dot(ref cross, ref AD, out volume);
        ...
        public void UpdateCachedSimplex(ref CachedSimplex simplex)
        {
            ...
            {
                case SimplexState.Point:
                    BepuVector3.Subtract(ref SimplexB.A, ref LocalTransformB.Position, out simplex.LocalSimplexB.A);
                    BepuQuaternion conjugate;
                    BepuQuaternion.Conjugate(ref LocalTransformB.Orientation, out conjugate);
                    BepuQuaternion.Transform(ref simplex.LocalSimplexB.A, ref conjugate, out simplex.LocalSimplexB.A);
                    break;
                case SimplexState.Segment:
                    BepuVector3.Subtract(ref SimplexB.A, ref LocalTransformB.Position, out simplex.LocalSimplexB.A);
                    BepuVector3.Subtract(ref SimplexB.B, ref LocalTransformB.Position, out simplex.LocalSimplexB.B);
                ...
                case SimplexState.Triangle:
                    BepuVector3.Subtract(ref SimplexB.A, ref LocalTransformB.Position, out simplex.LocalSimplexB.A);
                    BepuVector3.Subtract(ref SimplexB.B, ref LocalTransformB.Position, out simplex.LocalSimplexB.B);
                    BepuVector3.Subtract(ref SimplexB.C, ref LocalTransformB.Position, out simplex.LocalSimplexB.C);
                ...
                case SimplexState.Tetrahedron:
                    ...
                    BepuVector3.Subtract(ref SimplexB.B, ref LocalTransformB.Position, out simplex.LocalSimplexB.B);
                    BepuVector3.Subtract(ref SimplexB.C, ref LocalTransformB.Position, out simplex.LocalSimplexB.C);
                    BepuVector3.Subtract(ref SimplexB.D, ref LocalTransformB.Position, out simplex.LocalSimplexB.D);
        ...
        public bool GetPointClosestToOrigin(out BepuVector3 point)
        {
        ...
        public void GetPointOnSegmentClosestToOrigin(out BepuVector3 point)
        {
            BepuVector3 segmentDisplacement;
            BepuVector3.Subtract(ref B, ref A, out segmentDisplacement);

            Fix64 dotA;
            BepuVector3.Dot(ref segmentDisplacement, ref A, out dotA);
            if (dotA > F64.C0)
            {
            ...
            Fix64 dotB;
            BepuVector3.Dot(ref segmentDisplacement, ref B, out dotB);
            if (dotB > F64.C0)
            {
                //Inside segment.
                U = dotB / segmentDisplacement.LengthSquared();
                V = F64.C1 - U;
                BepuVector3.Multiply(ref segmentDisplacement, V, out point);
                BepuVector3.Add(ref point, ref A, out point);
                return;
        ...
        ///</summary>
        ///<param name="point">Point closest to origin.</param>
        public void GetPointOnTriangleClosestToOrigin(out BepuVector3 point)
        {
            BepuVector3 ab, ac;
            BepuVector3.Subtract(ref B, ref A, out ab);
            BepuVector3.Subtract(ref C, ref A, out ac);
            ...
            Fix64 AdotAB, AdotAC;
            BepuVector3.Dot(ref ab, ref A, out AdotAB);
            BepuVector3.Dot(ref ac, ref A, out AdotAC);
            AdotAB = -AdotAB;
            AdotAC = -AdotAC;
            ...
            Fix64 BdotAB, BdotAC;
            BepuVector3.Dot(ref ab, ref B, out BdotAB);
            BepuVector3.Dot(ref ac, ref B, out BdotAC);
            BdotAB = -BdotAB;
            BdotAC = -BdotAC;
            ...
            if (vc <= F64.C0 && AdotAB > F64.C0 && BdotAB < F64.C0)//Note > and < instead of => <=; avoids possibly division by zero
            {
                ...
                BepuVector3.Multiply(ref ab, V, out point);
                BepuVector3.Add(ref point, ref A, out point);
                return;
            }
            ...
            Fix64 CdotAB, CdotAC;
            BepuVector3.Dot(ref ab, ref C, out CdotAB);
            BepuVector3.Dot(ref ac, ref C, out CdotAC);
            CdotAB = -CdotAB;
            CdotAC = -CdotAC;
            ...
            if (vb <= F64.C0 && AdotAC > F64.C0 && CdotAC < F64.C0)//Note > instead of >= and < instead of <=; prevents bad denominator
            {
                ...
                U = F64.C1 - V;
                BepuVector3.Multiply(ref ac, V, out point);
                BepuVector3.Add(ref point, ref A, out point);
                return;
            }
            ...
            if (va <= F64.C0 && (d3d4 = BdotAC - BdotAB) > F64.C0 && (d6d5 = CdotAB - CdotAC) > F64.C0)//Note > instead of >= and < instead of <=; prevents bad denominator
            {
                ...
                BepuVector3 bc;
                BepuVector3.Subtract(ref C, ref B, out bc);
                BepuVector3.Multiply(ref bc, U, out point);
                BepuVector3.Add(ref point, ref B, out point);
                return;
            }
            ...
            BepuVector3.Add(ref A, ref point, out point);
            BepuVector3.Add(ref point, ref acw, out point);
        ...
        public bool GetPointOnTetrahedronClosestToOrigin(out BepuVector3 point)
        {
        ...
        private static bool TryTetrahedronTriangle(ref BepuVector3 A, ref BepuVector3 B, ref BepuVector3 C,
                                                   ref BepuVector3 A1, ref BepuVector3 B1, ref BepuVector3 C1,
                                                   ref BepuVector3 A2, ref BepuVector3 B2, ref BepuVector3 C2,
                                                   Fix64 errorTolerance,
                                                   ref BepuVector3 otherPoint, out PairSimplex simplex, out BepuVector3 point)
        {
            ...
            BepuVector3.Subtract(ref C, ref A, out ac);
            BepuVector3 normal;
            BepuVector3.Cross(ref ab, ref ac, out normal);
            Fix64 AdotN, ADdotN;
            BepuVector3 AD;
            BepuVector3.Subtract(ref otherPoint, ref A, out AD);
            BepuVector3.Dot(ref A, ref normal, out AdotN);
            BepuVector3.Dot(ref AD, ref normal, out ADdotN);
            ...
            if (AdotN * ADdotN >= -Toolbox.Epsilon * errorTolerance)
            {
                ...
                if (vc <= F64.C0 && AdotAB > F64.C0 && BdotAB < F64.C0) //Note > and < instead of => <=; avoids possibly division by zero
                {
                    ...
                    BepuVector3.Multiply(ref ab, simplex.V, out point);
                    BepuVector3.Add(ref point, ref A, out point);
                    return true;
                }
                ...
                if (vb <= F64.C0 && AdotAC > F64.C0 && CdotAC < F64.C0) //Note > instead of >= and < instead of <=; prevents bad denominator
                {
                    ...
                    simplex.U = F64.C1 - simplex.V;
                    BepuVector3.Multiply(ref ac, simplex.V, out point);
                    BepuVector3.Add(ref point, ref A, out point);
                    return true;
                }
                ...
                if (va <= F64.C0 && (d3d4 = BdotAC - BdotAB) > F64.C0 && (d6d5 = CdotAB - CdotAC) > F64.C0)//Note > instead of >= and < instead of <=; prevents bad denominator
                {
                    ...
                    BepuVector3 bc;
                    BepuVector3.Subtract(ref C, ref B, out bc);
                    BepuVector3.Multiply(ref bc, simplex.V, out point);
                    BepuVector3.Add(ref point, ref B, out point);
                    return true;
                }
                ...
                BepuVector3.Multiply(ref ab, simplex.V, out point);
                BepuVector3 acw;
                BepuVector3.Multiply(ref ac, simplex.W, out acw);
                BepuVector3.Add(ref A, ref point, out point);
                BepuVector3.Add(ref point, ref acw, out point);
                return true;
            }
        ...
        public bool GetNewSimplexPoint(ConvexShape shapeA, ConvexShape shapeB, int iterationCount, ref BepuVector3 closestPoint)
        {
            BepuVector3 negativeDirection;
            BepuVector3.Negate(ref closestPoint, out negativeDirection);
            BepuVector3 sa, sb;
            ...
            BepuVector3 S;
            BepuVector3.Subtract(ref sa, ref sb, out S);
            //If S is not further towards the origin along negativeDirection than closestPoint, then we're done.
            Fix64 dotS;
            BepuVector3.Dot(ref S, ref negativeDirection, out dotS); //-P * S
        ...
        public void GetClosestPoints(out BepuVector3 closestPointA, out BepuVector3 closestPointB)
        {
            //A * U + B * V + C * W
            switch (State)
            {
                ...
                case SimplexState.Segment:
                    BepuVector3 temp;
                    BepuVector3.Multiply(ref SimplexA.A, U, out closestPointA);
                    BepuVector3.Multiply(ref SimplexA.B, V, out temp);
                    BepuVector3.Add(ref closestPointA, ref temp, out closestPointA);

                    BepuVector3.Multiply(ref SimplexB.A, U, out closestPointB);
                    BepuVector3.Multiply(ref SimplexB.B, V, out temp);
                    BepuVector3.Add(ref closestPointB, ref temp, out closestPointB);
                    return;
                case SimplexState.Triangle:
                    BepuVector3.Multiply(ref SimplexA.A, U, out closestPointA);
                    BepuVector3.Multiply(ref SimplexA.B, V, out temp);
                    BepuVector3.Add(ref closestPointA, ref temp, out closestPointA);
                    BepuVector3.Multiply(ref SimplexA.C, W, out temp);
                    BepuVector3.Add(ref closestPointA, ref temp, out closestPointA);

                    BepuVector3.Multiply(ref SimplexB.A, U, out closestPointB);
                    BepuVector3.Multiply(ref SimplexB.B, V, out temp);
                    BepuVector3.Add(ref closestPointB, ref temp, out closestPointB);
                    BepuVector3.Multiply(ref SimplexB.C, W, out temp);
                    BepuVector3.Add(ref closestPointB, ref temp, out closestPointB);
                    return;
            }
        ...
        internal void VerifyContributions()
        {
            ...
            {
                case SimplexState.Point:
                    if (BepuVector3.Distance(SimplexA.A - SimplexB.A, A) > F64.C1em4)
                ...
                case SimplexState.Segment:
                    ...
                    if (BepuVector3.Distance(SimplexA.B - SimplexB.B, B) > F64.C1em4)
                        Debug.WriteLine("break.");
                    break;
                case SimplexState.Triangle:
                    if (BepuVector3.Distance(SimplexA.A - SimplexB.A, A) > F64.C1em4)
                    ...
                    if (BepuVector3.Distance(SimplexA.C - SimplexB.C, C) > F64.C1em4)
                        Debug.WriteLine("break.");
                    break;
                ...
                case SimplexState.Tetrahedron:
                    ...
                    if (BepuVector3.Distance(SimplexA.D - SimplexB.D, D) > F64.C1em4)
                        Debug.WriteLine("break.");
                    break;
            }
        }
