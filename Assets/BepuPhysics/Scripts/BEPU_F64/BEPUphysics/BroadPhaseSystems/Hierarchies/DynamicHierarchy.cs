...
namespace BEPUphysics.BroadPhaseSystems.Hierarchies
{
    ...
    public class DynamicHierarchy : BroadPhase
    {
        ...
        public override void Add(BroadPhaseEntry entry)
        {
            ...
            BepuVector3 offset;
            BepuVector3.Subtract(ref entry.boundingBox.Max, ref entry.boundingBox.Min, out offset);
            ...
            else
            {
                ...
                else
                {
                    ...
                    BepuVector3.Subtract(ref root.BoundingBox.Max, ref root.BoundingBox.Min, out offset);
