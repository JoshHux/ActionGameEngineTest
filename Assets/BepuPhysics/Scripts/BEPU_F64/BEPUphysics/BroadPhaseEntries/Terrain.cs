    ...
    public class Terrain : StaticCollidable
    {
        ...
        public AffineTransform WorldTransform
        {
            ...
            set
            {
                ...
                if (BepuVector3.Dot(normalTransform.Up, worldTransform.LinearTransform.Up) < F64.C0)
                {
        ...
        public Fix64 Thickness
        {
            ...
            set
            {
                ...
                BepuVector3 down = BepuVector3.Normalize(worldTransform.LinearTransform.Down);
                BepuVector3 thicknessOffset = down * (value - thickness);
        ...
        public override void UpdateBoundingBox()
        {
            ...
            BepuVector3 thicknessOffset = BepuVector3.Normalize(worldTransform.LinearTransform.Down) * thickness;
        ...
        public override bool ConvexCast(CollisionShapes.ConvexShapes.ConvexShape castShape, ref RigidTransform startingTransform, ref BepuVector3 sweep, out RayHit hit)
        {
            hit = new RayHit();
        ...
        public void GetPosition(int i, int j, out BepuVector3 position)
        {
