...
namespace BEPUphysics.CollisionShapes.ConvexShapes
{
    ...
    public struct OrientedConvexShapeEntry
    {
        ...
        public OrientedConvexShapeEntry(BepuQuaternion orientation, ConvexShape shape)
        {
    ...
    public class MinkowskiSumShape : ConvexShape
    {
        ...
        public MinkowskiSumShape(OrientedConvexShapeEntry firstShape, OrientedConvexShapeEntry secondShape, out BepuVector3 center)
        ...
        /// <param name="shapeEntries">Entries composing the minkowski sum.</param>
        /// <param name="center">Center of the minkowski sum computed pre-recentering.</param>
        public MinkowskiSumShape(IList<OrientedConvexShapeEntry> shapeEntries, out BepuVector3 center)
            : this(shapeEntries)
        {
            center = -localOffset;
        }
        ...
        public MinkowskiSumShape(IList<OrientedConvexShapeEntry> shapeEntries, BepuVector3 localOffset, ConvexShapeDescription description)
        {
            for (int i = 0; i < shapeEntries.Count; i++)
            {
                shapes.Add(shapeEntries[i]);
        ...
        public override void GetLocalExtremePointWithoutMargin(ref BepuVector3 direction, out BepuVector3 extremePoint)
        {
            ...
            for (int i = 1; i < shapes.WrappedList.Count; i++)
            {
                ...
                BepuVector3.Add(ref extremePoint, ref temp, out extremePoint);
            }
            BepuVector3.Add(ref extremePoint, ref localOffset, out extremePoint);
        }
