...
namespace BEPUphysics.Constraints
{
    ...
    public interface I1DJacobianConstraint
    {
        ...
        void GetAngularJacobianA(out BepuVector3 jacobian);

        /// <summary>
        /// Gets the angular jacobian entry for the second connected entity.
        /// </summary>
        /// <param name="jacobian">Angular jacobian entry for the second connected entity.</param>
        void GetAngularJacobianB(out BepuVector3 jacobian);

        /// <summary>
        /// Gets the linear jacobian entry for the first connected entity.
        /// </summary>
        /// <param name="jacobian">Linear jacobian entry for the first connected entity.</param>
        void GetLinearJacobianA(out BepuVector3 jacobian);

        /// <summary>
        /// Gets the linear jacobian entry for the second connected entity.
        /// </summary>
        /// <param name="jacobian">Linear jacobian entry for the second connected entity.</param>
        void GetLinearJacobianB(out BepuVector3 jacobian);
    ...
    public interface I2DJacobianConstraint
    {
        ...
        void GetAngularJacobianA(out BepuVector3 jacobianX, out BepuVector3 jacobianY);
        ...
        void GetAngularJacobianB(out BepuVector3 jacobianX, out BepuVector3 jacobianY);
        ...
        void GetLinearJacobianA(out BepuVector3 jacobianX, out BepuVector3 jacobianY);
        ...
        void GetLinearJacobianB(out BepuVector3 jacobianX, out BepuVector3 jacobianY);
    ...
    public interface I3DJacobianConstraint
    {
        ...
        void GetAngularJacobianA(out BepuVector3 jacobianX, out BepuVector3 jacobianY, out BepuVector3 jacobianZ);
        ...
        void GetAngularJacobianB(out BepuVector3 jacobianX, out BepuVector3 jacobianY, out BepuVector3 jacobianZ);
        ...
        void GetLinearJacobianA(out BepuVector3 jacobianX, out BepuVector3 jacobianY, out BepuVector3 jacobianZ);
        ...
        void GetLinearJacobianB(out BepuVector3 jacobianX, out BepuVector3 jacobianY, out BepuVector3 jacobianZ);
