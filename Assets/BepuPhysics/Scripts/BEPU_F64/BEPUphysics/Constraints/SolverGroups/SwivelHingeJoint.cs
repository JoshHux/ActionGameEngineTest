...
namespace BEPUphysics.Constraints.SolverGroups
{
    ...
    public class SwivelHingeJoint : SolverGroup
    {
        ...
        public SwivelHingeJoint(Entity connectionA, Entity connectionB, BepuVector3 anchor, BepuVector3 hingeAxis)
        {
            if (connectionA == null)
            ...
            BepuVector3 baseAxis = anchor - connectionA.position;
            ...
            baseAxis -= BepuVector3.Dot(baseAxis, hingeAxis) * hingeAxis;
            if (baseAxis.LengthSquared() < Toolbox.BigEpsilon)
            {
                ...
                baseAxis = BepuVector3.Cross(hingeAxis, BepuVector3.Up);
                if (baseAxis.LengthSquared() < Toolbox.BigEpsilon)
                {
                    baseAxis = BepuVector3.Cross(hingeAxis, BepuVector3.Right);
                }
            }
