...
namespace BEPUphysics.Constraints.SolverGroups
{
    ...
    public class WeldJoint : SolverGroup
    {
        ...
        private static BepuVector3 GetAnchorGuess(Entity connectionA, Entity connectionB)
        {
            var anchor = new BepuVector3();
            if (connectionA != null)
        ...
        public WeldJoint(Entity connectionA, Entity connectionB, BepuVector3 anchor)
        {
            if (connectionA == null)
