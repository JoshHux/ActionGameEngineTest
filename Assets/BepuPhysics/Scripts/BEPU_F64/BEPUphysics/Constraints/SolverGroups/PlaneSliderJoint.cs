...
namespace BEPUphysics.Constraints.SolverGroups
{
    ...
    public class PlaneSliderJoint : SolverGroup
    {
        ...
        public PlaneSliderJoint(Entity connectionA, Entity connectionB, BepuVector3 planeAnchor, BepuVector3 planeNormal, BepuVector3 xAxis, BepuVector3 yAxis, BepuVector3 pointAnchor)
        {
            if (connectionA == null)
