...
namespace BEPUphysics.Entities.Prefabs
{
    ...
    public class Triangle : Entity<ConvexCollidable<TriangleShape>>
    {
        ...
        ///</summary>
        public BepuVector3 LocalVertexA
        {
            get
            {
        ...
        ///</summary>
        public BepuVector3 LocalVertexB
        {
            get
            {
        ...
        ///</summary>
        public BepuVector3 LocalVertexC
        {
            get
            {
        ...
        public Triangle(BepuVector3 v1, BepuVector3 v2, BepuVector3 v3, Fix64 mass)
        {
            BepuVector3 center;
        ...
        /// <param name="v2">Position of the second vertex.</param>
        /// <param name="v3">Position of the third vertex.</param>
        public Triangle(BepuVector3 v1, BepuVector3 v2, BepuVector3 v3)
        {
            BepuVector3 center;
            var shape = new TriangleShape(v1, v2, v3, out center);
        ...
        /// <param name="v3">Position of the third vertex.</param>
        /// <param name="mass">Mass of the object.</param>
        public Triangle(BepuVector3 pos, BepuVector3 v1, BepuVector3 v2, BepuVector3 v3, Fix64 mass)
            : this(v1, v2, v3, mass)
        {
            Position = pos;
        }
        ...
        /// <param name="v2">Position of the second vertex.</param>
        /// <param name="v3">Position of the third vertex.</param>
        public Triangle(BepuVector3 pos, BepuVector3 v1, BepuVector3 v2, BepuVector3 v3)
            : this(v1, v2, v3)
        {
            Position = pos;
        }
        ...
        /// <param name="v3">Position of the third vertex.</param>
        /// <param name="mass">Mass of the object.</param>
        public Triangle(MotionState motionState, BepuVector3 v1, BepuVector3 v2, BepuVector3 v3, Fix64 mass)
            : this(v1, v2, v3, mass)
        {
        ...
        /// <param name="v2">Position of the second vertex.</param>
        /// <param name="v3">Position of the third vertex.</param>
        public Triangle(MotionState motionState, BepuVector3 v1, BepuVector3 v2, BepuVector3 v3)
            : this(v1, v2, v3)
        {
            MotionState = motionState;
        }
