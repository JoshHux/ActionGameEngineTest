...
namespace BEPUphysics.Entities.Prefabs
{
    ...
    public class ConvexHull : Entity<ConvexCollidable<ConvexHullShape>>
    {
        ...
        public ConvexHull(IList<BepuVector3> points)
        {
            BepuVector3 center;
        ...
        public ConvexHull(IList<BepuVector3> points, Fix64 mass)
        {
            BepuVector3 center;
            var shape = new ConvexHullShape(points, out center);
        ...
        /// <param name="points">List of points in the object.</param>
        /// <param name="mass">Mass of the object.</param>
        public ConvexHull(BepuVector3 position, IList<BepuVector3> points, Fix64 mass)
            : this(points, mass)
        {
            Position = position;
        }
        ...
        /// <param name="position">Position to place the convex hull.</param>
        /// <param name="points">List of points in the object.</param>
        public ConvexHull(BepuVector3 position, IList<BepuVector3> points)
            : this(points)
        {
            Position = position;
        }
        ...
        /// <param name="points">List of points in the object.</param>
        /// <param name="mass">Mass of the object.</param>
        public ConvexHull(MotionState motionState, IList<BepuVector3> points, Fix64 mass)
            : this(points, mass)
        {
        ...
        /// <param name="motionState">Motion state specifying the entity's initial state.</param>
        /// <param name="points">List of points in the object.</param>
        public ConvexHull(MotionState motionState, IList<BepuVector3> points)
            : this(points)
        {
            MotionState = motionState;
        }
