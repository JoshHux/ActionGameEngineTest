...
namespace BEPUphysics.Entities.Prefabs
{
    ...
    public class MobileMesh : Entity<MobileMeshCollidable>
    {
        ...
        public MobileMesh(BepuVector3[] vertices, int[] indices, AffineTransform localTransform, MobileMeshSolidity solidity)
        {
            BepuVector3 center;
        ...
        public MobileMesh(BepuVector3[] vertices, int[] indices, AffineTransform localTransform, MobileMeshSolidity solidity, Fix64 mass)
        {
            BepuVector3 center;
            var shape = new MobileMeshShape(vertices, indices, localTransform, solidity, out center);
