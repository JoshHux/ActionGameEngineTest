...
namespace BEPUphysics.Paths
{
    ...
    /// </summary>
    public class LinearInterpolationCurve3D : Curve<BepuVector3>
    {
        /// <summary>
        ...
        {
            value = BepuVector3.Lerp(ControlPoints[controlPointIndex].Value, ControlPoints[controlPointIndex + 1].Value, weight);
        }
        ...
        //public override void evaluate(double time, out BepuVector3 value)
        //{
        //    int maxIndex = controlPoints.count - 1;
        //    if (maxIndex == -1)
        //    {
        //        value = BepuVector3.Zero;
        //        return;
        //    }
        ...
        //    value = BepuVector3.Lerp(controlPoints[index].value, controlPoints[nextIndex].value, intervalTime); 
