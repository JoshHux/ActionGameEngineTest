...
namespace BEPUphysics.DataStructures
{
    ...
    public abstract class MeshBoundingBoxTreeData
    {
        ...
        {
            BepuVector3 v1, v2, v3;
            GetTriangle(triangleIndex, out v1, out v2, out v3);
            BepuVector3.Min(ref v1, ref v2, out boundingBox.Min);
            BepuVector3.Min(ref boundingBox.Min, ref v3, out boundingBox.Min);
            BepuVector3.Max(ref v1, ref v2, out boundingBox.Max);
            BepuVector3.Max(ref boundingBox.Max, ref v3, out boundingBox.Max);
        ...
        public abstract void GetTriangle(int triangleIndex, out BepuVector3 v1, out BepuVector3 v2, out BepuVector3 v3);
        ///<summary>
        ...
        public abstract void GetVertexPosition(int i, out BepuVector3 vertex);
    }
}
