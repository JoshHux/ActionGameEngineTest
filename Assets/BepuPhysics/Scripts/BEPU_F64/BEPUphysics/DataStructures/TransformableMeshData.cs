...
namespace BEPUphysics.DataStructures
{
    ...
    public class TransformableMeshData : MeshBoundingBoxTreeData
    {
        ...
        public TransformableMeshData(BepuVector3[] vertices, int[] indices)
        {
            Vertices = vertices;
            Indices = indices;
        }
        ...
        public TransformableMeshData(BepuVector3[] vertices, int[] indices, AffineTransform worldTransform)
        {
        ...
        public override void GetTriangle(int triangleIndex, out BepuVector3 v1, out BepuVector3 v2, out BepuVector3 v3)
        {
        ...
        public override void GetVertexPosition(int i, out BepuVector3 vertex)
        {
