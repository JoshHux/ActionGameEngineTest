...
public class DWorld : MonoBehaviour{
    ...
    public void Step(Fix32 delta) {
        ...
        //integrate forces
        UnityEngine.Profiling.Profiler.BeginSample("Integrate forces");
        ...
        UnityEngine.Profiling.Profiler.BeginSample("Find collisions");
        ...
        foreach (DBody body in bodies) {
            ...
            UnityEngine.Profiling.Profiler.BeginSample("Remove-Integrate-Insert");
